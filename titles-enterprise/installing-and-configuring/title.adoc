...
As a developer or system administrator, you can install {PRODUCT_PAM} components on {EAP}, in an {EAP} clustered environment, on JBoss Web Server, and in other supported environments.

...
As a developer or system administrator, you can install Red Hat Process Automation Manager components on {EAP}, in an {EAP} clustered environment, on JBoss Web Server, and in other supported environments.

...
As a developer or system administrator, you can integrate {PRODUCT} with other products and components, such as Spring Boot, Red Hat Single Sign-On, and other supported products.
...
// Fuse excluded until Fuse 7.9 GA

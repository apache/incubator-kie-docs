...
As a developer or system administrator, you can integrate {PRODUCT_PAM} with other products and components, such as Spring Boot, {RH-SSO}, and other supported products.

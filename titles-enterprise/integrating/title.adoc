...
As a developer or system administrator, you can integrate Red Hat Process Automation Manager with other products and components, such as Spring Boot, {RH-SSO}, and other supported products.

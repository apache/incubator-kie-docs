...
include::rules/guided-rule-templates-con.adoc[leveloffset=+1]

include::project-data/data-objects-con.adoc[leveloffset=+1]

include::project-data/data-objects-create-proc.adoc[leveloffset=+2]

include::rules/guided-rule-templates-create-proc.adoc[leveloffset=+1]

include::rules/guided-rule-templates-WHEN-proc.adoc[leveloffset=+2]

include::rules/guided-rule-templates-THEN-proc.adoc[leveloffset=+2]

include::rules/guided-rules-options-proc.adoc[leveloffset=+2]

include::rules/rules-attributes-ref.adoc[leveloffset=+3]

include::rules/guided-rule-templates-tables-proc.adoc[leveloffset=+1]

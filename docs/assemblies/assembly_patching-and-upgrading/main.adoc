...
include::installation/product-versioning-con.adoc[leveloffset=+1]

include::installation/patches-notifications-proc.adoc[leveloffset=+1]

include::installation/patches-applying-proc.adoc[leveloffset=+1]

// For DM/PAM 7.1
//include::installation/upgrading-minor-release-proc.adoc[leveloffset=+1]

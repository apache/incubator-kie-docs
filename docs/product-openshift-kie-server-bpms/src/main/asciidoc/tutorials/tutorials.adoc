...
Preparation of the BPMS project may require some prior knowledge with the Red Hat JBoss BPM Suite. Refer to the https://access.redhat.com/documentation/en-US/Red_Hat_JBoss_BPM_Suite/6.3/html/User_Guide/[Red Hat JBoss BPM Suite User Guide] for more information on any of these tasks.

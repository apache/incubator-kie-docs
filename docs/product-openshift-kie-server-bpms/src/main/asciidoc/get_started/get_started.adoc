...
. Process Instance ID (specific to IPS/{PRODUCT})
. Correlation Key (specific to IPS/{PRODUCT})
. Task Instance ID (specific to IPS/{PRODUCT})
. Work Item ID (specific to IPS/{PRODUCT})
. Job Request ID (specific to IPS/{PRODUCT})
. Conversation ID

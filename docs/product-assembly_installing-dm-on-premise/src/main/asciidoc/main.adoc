...
include::product-installation-guide/controller-standalone-con.adoc[leveloffset=+2]
include::product-installation-guide/controller-standalone-eap-install-proc.adoc[leveloffset=+3]
include::product-installation-guide/controller-standalone-jws-install-proc.adoc[leveloffset=+3]

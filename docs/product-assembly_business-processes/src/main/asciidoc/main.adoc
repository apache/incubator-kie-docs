...
*<MH>Goal of this draft is to have a working scenario for Sree's 4/13 hackfest, but ER2 is not working properly to achieve a full scenario. Collaborating with Sree on the best approach</MH>*

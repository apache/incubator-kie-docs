...
include::product-getting-started-guide/concept_key-benefits.adoc[leveloffset=+2]

include::product-getting-started-guide/concept_model.adoc[leveloffset=+2]

include::product-getting-started-guide/concept_deploy.adoc[leveloffset=+2]

include::product-getting-started-guide/concept_execute.adoc[leveloffset=+2]

include::product-getting-started-guide/concept_monitor.adoc[leveloffset=+2]

include::product-getting-started-guide/concept_use-cases.adoc[leveloffset=+2]

include::product-getting-started-guide/concept_scenario.adoc[leveloffset=+1]
...
include::product-getting-started-guide/task_deploying-application.adoc[leveloffset=+1]

include::product-getting-started-guide/executing-proc.adoc[leveloffset=+1]

include::product-getting-started-guide/monitor-proc.adoc[leveloffset=+1]

...
As a business analyst or business rules developer, you can define business rules using the guided rules designer in {CENTRAL}. These guided rules are compiled into DRL (Drools Rule Language) and form the core of the decision service for your project.

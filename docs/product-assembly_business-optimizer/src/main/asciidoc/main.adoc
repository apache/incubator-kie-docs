...
= Solve planning problems and author planning assets
include::product-business-resource-planner-guide/AuthoringPlanningAssets/optimizer-solver-configuration-proc.adoc[leveloffset=+1]
include::product-business-resource-planner-guide/AuthoringPlanningAssets/optimizer-solver-termination-proc.adoc[leveloffset=+2]
include::product-business-resource-planner-guide/AuthoringPlanningAssets/optimizer-domain-editor-con.adoc[leveloffset=+1]
include::product-business-resource-planner-guide/AuthoringPlanningAssets/optimizer-difficulty-comparitor-proc.adoc[leveloffset=+1]
include::product-business-resource-planner-guide/AuthoringPlanningAssets/optimizer-score-constraints-guided-rules-proc.adoc[leveloffset=+1]

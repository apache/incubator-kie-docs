...
include::product-business-resource-planner-guide/AuthoringPlanningAssets/SolverEditor-section.adoc[leveloffset=+1]
include::product-business-resource-planner-guide/AuthoringPlanningAssets/DomainEditor-section.adoc[leveloffset=+1]
include::product-business-resource-planner-guide/AuthoringPlanningAssets/GuidedRuleEditor-section.adoc[leveloffset=+1]

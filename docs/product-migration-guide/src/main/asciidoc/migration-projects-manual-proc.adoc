...
If you encounter errors that you cannot resolve when using Red Hat's project migration tool, you can manually restructure your `.niogit` directory for {PRODUCT_OLD} and import each project repository individually to {PRODUCT} {PRODUCT_VERSION}.

...
For more information, see Planning the {PRODUCT} {PRODUCT_VERSION} installation.
//@link: Update install link above.
endif::[]
ifeval::["{context}" == "exec-server"]
For installation information, see Planning the {PRODUCT} {PRODUCT_VERSION} installation. For configuration information, see xref:migration-configure-kie-server-proc[].
//@link: Update install link above.
endif::[]

...
= Using the {CENTRAL} migration tool
...
After the tool finishes running, the `.niogit` directory structure is then compatible with {CENTRAL} in {PRODUCT} {PRODUCT_VERSION}.

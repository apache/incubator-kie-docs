...
include::product-assembly_revising-projects/git-import-project.adoc[leveloffset=+1]

include::product-assembly_revising-projects/revise-project-version.adoc[leveloffset=+1]

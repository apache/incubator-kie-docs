...
After you have configured all required environment variables and system properties in {WEBSPHERE}, you can install {KIE_SERVER} with {WEBSPHERE_SHORT} to streamline {PRODUCT} application management.
...
. Click *Finish* to install the {KIE_SERVER} and click *Save* to save the changes to the master configuration.

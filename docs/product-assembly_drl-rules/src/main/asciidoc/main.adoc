...
include::product-user-guide/drl-rules-create-central-proc.adoc[leveloffset=+1]
...
Creating DRL files with external tools
  Creating DRL files in Developer Stuidio
  Creating Rules in Plain Java
  Creating Rules in Maven

Advanced DRL concepts and actions (from Dev Guide chap. 9)

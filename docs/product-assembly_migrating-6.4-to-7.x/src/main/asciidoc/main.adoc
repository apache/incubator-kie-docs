...
include::product-migration-guide/migration-tool-7.x-con.adoc[leveloffset=+2]

:context: non-exec-server
include::product-migration-guide/migration-tool-niogit-7.x-proc.adoc[leveloffset=+3]

:context: non-exec-server
include::product-migration-guide/migration-tool-repo-7.x-proc.adoc[leveloffset=+3]

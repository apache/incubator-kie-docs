...
include::migration-projects-con.adoc[leveloffset=+1]

include::migration-projects-tool-proc.adoc[leveloffset=+2]

include::migration-projects-manual-proc.adoc[leveloffset=+2]


include::projects-central-migrating-proc.adoc[leveloffset=+1]

migration-live-instance-migrating-proc

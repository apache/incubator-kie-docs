...
. Click image:dots.png[] in the upper-right corner of the *Price* row and click *Remove*.
. Click image:dots.png[] in the upper-right corner of the *ExtraIngredients* row and click *Edit*.

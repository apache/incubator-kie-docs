...
* Wildfly 10 / EAP 7 distribution - Both distributions use the Wildfly security provider configured for the use of the default `application-users.properties` `and application-roles.properties` default realm files.

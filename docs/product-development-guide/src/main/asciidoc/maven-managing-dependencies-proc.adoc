...
* To use assets in `KJAR` packaging, include the `kie-maven-plugin` artifact. In this example `${kie.version}` is the Maven library version listed in https://access.redhat.com/solutions/3405361[What is the mapping between RHPAM product and maven library version?]:
+
[source,xml]
----

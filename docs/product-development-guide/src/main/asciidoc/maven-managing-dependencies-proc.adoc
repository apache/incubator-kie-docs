...
For standalone project that are not authored in {CENTRAL} you must specify all required dependencies. In projects that you author in {CENTRAL}, the basic Drools/jBPM engine dependencies are provided automatically by the B{CENTRAL}.

...
The {PRODUCT} ZIP files do not require a graphical user interface so you can install {PRODUCT} using SSH. It consists of two ZIP files, one for {CENTRAL} and one for {KIE_SERVER}.

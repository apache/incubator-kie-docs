...
For list of supported properties, see https://github.com/kiegroup/kie-docs/blob/master/docs/shared-kie-docs/src/main/asciidoc/Workbench/Installation/Installation-section.adoc[Installation System Properties].

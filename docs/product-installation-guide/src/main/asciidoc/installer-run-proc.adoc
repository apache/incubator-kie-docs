...
+
. If you selected *Customize database settings*, on the JDBC Drive Configuration page specify a JDBC driver vendor, select one or more Driver JAR files, and click *Next*.

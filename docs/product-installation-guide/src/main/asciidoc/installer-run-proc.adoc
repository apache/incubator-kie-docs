...
* Select *{PRODUCT} execution server deployment* to install Decision Server.  COMMENT: Is this correct?
+
[NOTE]
====
...
You have successfully installed {PRODUCT} using the installer. If you installed only Decision Central, repeat these steps to install Decision Server in a separate container.

...
[NOTE]
====
It is possible install {CENTRAL} and {KIE_SERVER} on the same server. However, for production environments you should install them on different servers. To do this, run the installer twice.
====
+

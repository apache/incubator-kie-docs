[id='_chap_patching_and_upgrading']
...
* `eap6._x_`
* `eap6._x_-bc`
ifdef::BPMS[* `eap6._x_-dashbuilder`]
* `eap6._x_-kie-server`
* `generic`
* `generic-bc`
ifdef::BPMS[* `generic-dashbuilder`]
* `generic-kie-server`
* `was8`
* `was8-bc`
ifdef::BPMS[* `was8-dashbuilder`]
* `was8-kie-server`
* `wls12c`
* `wls12c-bc`
ifdef::BPMS[* `wls12c-dashbuilder`]
* `wls12c-kie-server`
ifdef::BRMS[* `brms-engine`]
ifdef::BPMS[* `bpmsuite-engine`]
* `planner-engine`
* `supplementary-tools`

...
This section describes how to install {KIE_SERVER} and the headless {PRODUCT_SHORT} controller using the installer JAR file. The JAR file is an executable file that installs {PRODUCT} in an existing 

...
COMMENT: Section need review.

After you have installed {KIE_SERVER}, you must configure it as described in this section.

.Prerequisites
{KIE_SERVER} installed in `__EAP_HOME__` as described in <<eap_execution_server_download_install_proc>>.

...
= Using the OpenShift Application Template for Business Central Monitoring, MySQL, and Smart Router
Use this template to install {PRODUCT} {PRODUCT_VERSION} {RELEASE} Business Central Monitoring, MySQL (Ephemeral plus https), and Smart Router in your OpenShift project. 

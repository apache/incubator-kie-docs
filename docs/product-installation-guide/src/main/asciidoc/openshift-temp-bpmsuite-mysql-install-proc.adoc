...
. Copy the path of the `bpmsuite70-full-mysql.json` file.
...
* Replace `<template-path>` with the path of the `bpmsuite70-full-mysql.json` file.
...
[NOTE]
====
View the `bpmsuite70-full-mysql.json` file for a list of all of the available parameters and their attributes. 
====

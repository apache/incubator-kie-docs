...
ifdef::PAM[]
(`rhpam-7.0.0.ER3-business-central-standalone.jar`).
endif::[]  
ifdef::DM[]
...
----
ifdef::PAM[]
java -jar rhpam-7.0.0.ER3-decision-central-standalone.jar -s application-config.yaml
endif::PAM[]
ifdef::DM[]
...
---- 
ifdef::PAM[]
java -jar rhpam-7.0.0.ER3-decision-central-standalone.jar -s application-config.yaml -D<property>=<value> -D<property>=<value>
endif::PAM[]
ifdef::DM[]

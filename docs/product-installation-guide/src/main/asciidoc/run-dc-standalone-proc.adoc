...
ifdef::PAM[]
(`rhpam-7.0.0.Beta01-business-central-standalone.jar`).
endif::[]  
ifdef::DM[]
...
----
ifdef::PAM[]
java -jar rhpam-7.0.0.Beta01-decision-central-standalone.jar -s application-config.yaml
endif::PAM[]
ifdef::DM[]
...
---- 
ifdef::PAM[]
java -jar rhpam-7.0.0.Beta01-decision-central-standalone.jar -s application-config.yaml -D<property>=<value> -D<property>=<value>
endif::PAM[]
ifdef::DM[]

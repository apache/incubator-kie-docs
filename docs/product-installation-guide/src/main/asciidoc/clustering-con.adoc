...
[NOTE]
====
This section is specifically intended for {PRODUCT} development environments where you want to cluster the Git repository. It is not necessary to create a clustered environment for {PRODUCT} production environments.
====

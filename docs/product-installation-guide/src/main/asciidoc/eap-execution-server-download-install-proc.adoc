...
. Copy the
ifdef::PAM[]
`__TEMP_DIR__/rhpam-7.0.0.Beta01-kie-server-ee7/rhpam-7.0.0.Beta01-kie-server-ee7/kie-server.war`
endif::PAM[]
ifdef::DM[]
...
ifdef::PAM[]
`__TEMP_DIR__/rhpam-7.0.0.Beta01-kie-server-ee7/rhpam-7.0.0.Beta01-kie-server-ee7/SecurityPolicy/`
endif::PAM[]
ifdef::DM[]

...
[source]
----
Specify the home directory of the following servers:  Red Hat JBoss EAP 7.1 or Tomcat 5
[/home/user/RHDM-7.0.0/jboss-eap-7.1]
----
+
. Enter the parent directory of an existing Red Hat JBoss Web Server 5.0 with Tomcat 5 installation.
+

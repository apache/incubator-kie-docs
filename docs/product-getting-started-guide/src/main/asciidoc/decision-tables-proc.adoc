...
The goal of this chapter is to introduce you to the *Mortgage Decision Table*. For this tutorial, you will not create and set the decision table conditions. Instead, you will review the information in the following image to gain an understanding of the values and the conditions as they are set in the predefined *MortgageDecisionTable* Guided Decision Tables asset.

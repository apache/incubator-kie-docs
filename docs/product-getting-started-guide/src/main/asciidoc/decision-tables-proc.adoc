...
Create guided decision tables in {PRODUCT} using the Guided Decision Table wizard, which leads you through the rule creation process. The Guided Rule wizard provides fields and options for acceptable input based on the object model of the rule.

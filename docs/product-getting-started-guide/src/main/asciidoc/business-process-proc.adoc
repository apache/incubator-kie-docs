...
Created the *Mortgage Process* data model. For further information, see <<defining_a_data_model>>.

.Related information
*<MH>Link to the already written overview user story doc that describes how to create a business process.</MH>*
...
. Expand *Implementation/Execution*, select *validation* in the *Ruleflow group* field.

...
{PRODUCT} enables you to automatically generate all forms. For this business process you are: Creating the Applicant form, Creating the Property form, and Creating the Application form.

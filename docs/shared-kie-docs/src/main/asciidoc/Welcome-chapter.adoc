...
The 7.x series will follow a more agile approach, with bi-weekly sprints and potentially monthly releases. We plan to do some bigger changes than normal for a series of minor releases, and users need to be aware those are coming before adopting.

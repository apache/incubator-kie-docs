...
If you want to use the per WAR approach, please take a look http://www.keycloak.org/docs/latest/securing_apps/index.html#required-per-war-configuration[Required Per WAR Configuration].

...
* A Keycloak security management provider is available to use in order to administrate the Keycloak realm from the administration area. Please read the instructions for updating the packaged application in order to use the Keycloak security provider https://github.com/kiegroup/appformer/tree/master/uberfire-extensions/uberfire-security/uberfire-security-management/uberfire-security-management-keycloak[here].

For more information about the user system administration please refer to https://github.com/kiegroup/appformer/blob/master/uberfire-extensions/uberfire-security/uberfire-security-management/README.md[this readme].

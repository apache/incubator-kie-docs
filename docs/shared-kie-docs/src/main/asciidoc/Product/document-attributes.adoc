...
:URL_RUNNING_ROSTER_FOR_PLANNER_IDE: {URL_BASE_ENTERPRISE}/running_and_modifying_the_employee_roster_starter_application_for_business_optimizer_using_an_IDE
:URL_RUNNING_ROSTER_FOR_PLANNER: {URL_BASE_ENTERPRISE}/running_the_employee_roster_starter_application_for_business_optimizer

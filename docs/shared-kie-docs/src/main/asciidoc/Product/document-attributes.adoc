...
ifdef::BAS[]
include::document-attributes-bas.adoc[]
endif::BAS[]
...
// Product names
:PRODUCT_BAS: Red Hat Business Automation Suite
:PRODUCT_DM: Red Hat Decision Manager
:PLANNER: Red Hat Resource Optimizer
...
:DEVELOPMENT_GUIDE: {PRODUCT_BAS} Development Guide
...
:MIGRATION_GUIDE: {PRODUCT_BAS} Migration Guide

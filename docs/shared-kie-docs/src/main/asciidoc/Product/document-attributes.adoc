...
Installing and configuring Red Hat Process Automation Manager on Red Hat JBoss Web Server 3.1 with Tomcat 8
...
Release notes for Red Hat Process Automation Manager 7.0

Getting started with case management
Designing and building cases
...
Implementing a process definition
Managing assets in Business Central

...
|Optional, at most once. In sequential mode this is used to set the start value of the salience. If omitted the default value is 65535.

|SequentialMinPriority
|Integer numeric value
|Optional, at most once. In sequential mode this is used to check if this minimum salience value is not violated. If omitted the default value is 0.

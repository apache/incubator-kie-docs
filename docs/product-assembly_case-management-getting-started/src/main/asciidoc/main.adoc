...
include::product-assembly_designing-and-building-cases/case-management-security-con.adoc[leveloffset=+1]
include::product-assembly_designing-and-building-cases/case-management-security-configuration-proc.adoc[leveloffset=+2]
...
include::product-assembly_designing-and-building-cases/case-management-closing-cases-ref.adoc[leveloffset=+1]

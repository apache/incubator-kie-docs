...
*** Connections can be attached to a concrete shape magnet. No matter the shape's location, the connection will target the specified magnet
...
** Toolbox re-design & usability enhancements. Lots of visual and usability improvements applied on the _toolbox_ for this release. It now supports multiple grids, floating grids, automatic layouts and much more

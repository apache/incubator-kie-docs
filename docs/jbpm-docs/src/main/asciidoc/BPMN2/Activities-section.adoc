...
.Script task
image::Chapter-5-CoreEngine/ScriptTask.png[]
...
.Service task
image::Chapter-5-CoreEngine/ServiceTask.png[]
...
.User task
image::Chapter-5-CoreEngine/UserTask.png[]
...
image::Chapter-5-CoreEngine/ReusableSubProcess.png[]
...
.Business rule task
image::Chapter-5-CoreEngine/BusinessRuleTask.png[]
...
.Embedded sub-process
image::Chapter-5-CoreEngine/EmbeddedSubProcess.png[]
...
.Multi-instance sub-process
image::Chapter-5-CoreEngine/MultipleInstances.png[]

...
Using MVEL is the default way to configure work items. This file will be placed in the project classpath in a directory called  [path]_META-INF_.
...
and do not need to be explicitly defined. If you are using any custom defined data type, the an import statement for it

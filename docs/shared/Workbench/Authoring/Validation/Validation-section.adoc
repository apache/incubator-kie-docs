...
.The Problems Panel
image::shared/Workbench/Authoring/Validation/workbench-problems-panel.png[align="center"]
...
image::shared/Workbench/Authoring/Validation/workbench-validation.png[align="center"]

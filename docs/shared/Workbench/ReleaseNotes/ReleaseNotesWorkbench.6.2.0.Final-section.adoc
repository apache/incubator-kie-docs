...
image::shared/Workbench/ReleaseNotes/zip_repo.png[]


.Download a folder
image::shared/Workbench/ReleaseNotes/zip_folder.png[]
...
image::shared/Workbench/ReleaseNotes/NewGuidedDecisionTableWizardValidation.png[]
...
image::shared/Workbench/ReleaseNotes/NewGuidedDecisionTableWizard.png[]
...
.Improved Metadata Tab
image::shared/Workbench/ReleaseNotes/ImprovedMetadataWidget.jpg[]
...
.Versions history
image::shared/Workbench/ReleaseNotes/ImprovedVersionsHistory.jpg[]
* Metadata
+ 
...
.Metadata section
image::shared/Workbench/ReleaseNotes/ImprovedMetadatSection.jpg[]
* Comments area
+ 
...
.Version selection dropdown
image::shared/Workbench/ReleaseNotes/ImprovedVersionsSelector.jpg[]
...
image::shared/Workbench/ReleaseNotes/NewJavaEditor.png[]
...
.Usages detection
image::shared/Workbench/ReleaseNotes/UsagesDetection.png[]
...
image::shared/Workbench/ReleaseNotes/NewExecutionServerManagementPerspective.png[]
...
image::shared/Workbench/ReleaseNotes/TimelinePerspective.png[]
...
.People Perspective
image::shared/Workbench/ReleaseNotes/PeoplePerspective.png[]


.Edit User Info
image::shared/Workbench/ReleaseNotes/PeoplePerspective1.png[]
...
image::shared/Workbench/ReleaseNotes/ContributorsPerspective.png[]
...
.Package selector
image::shared/Workbench/ReleaseNotes/PackageSelector.png[]
...
image::shared/Workbench/ReleaseNotes/GuidedDecisionTableNewPopup.png[]


.Example Guided Rule Editor popup
image::shared/Workbench/ReleaseNotes/GuidedRuleNewPopup.png[]
...
image::shared/Workbench/ReleaseNotes/GuidedDecisionTree1.png[]
...
image::shared/Workbench/ReleaseNotes/CreateRepositoryWizard1.png[]


.Create Repository Wizard 2/2
image::shared/Workbench/ReleaseNotes/CreateRepositoryWizard2.png[]
...
image::shared/Workbench/ReleaseNotes/ManagedRepositoryStructureScreen.png[]


.Repository Structure Screen for an Unmanaged Repository
image::shared/Workbench/ReleaseNotes/UnManagedRepositoryStructureScreen.png[]

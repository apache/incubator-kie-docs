...
* <<guided-decision-tables-columns-attribute-con, Add a new Attribute column>>
* <<guided-decision-tables-columns-metadata-con, Add a new Metadata column>>
* <<guided-decision-tables-columns-condition-con, Add a simple Condition>>
...
* <<guided-decision-tables-columns-field-work-item-con, Set the value of a field with a Work Item parameter>>

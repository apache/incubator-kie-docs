...
+
--
To view the project `pom.xml` in {CENTRAL}, select any existing asset in the project and then in the *Project Explorer* menu on the left side of the screen, click the settings icon and select *Repository View* -> *pom.xml*.

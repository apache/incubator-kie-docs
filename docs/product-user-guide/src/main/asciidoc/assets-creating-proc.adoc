...
.Procedure
. . In Business Central, click *Menu* -> *Projects* -> and click on the project name. For example, *MortgageProject*. (If you have not yet created a project, see xref:_assets_projects_gloss_chap-project[] for details.)

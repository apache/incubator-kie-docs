...
When enabled, this property disables by default any extensions or profiles provided beyond the DMN standard, such as some helper functions, enhanced features of DMN 1.2 backported into DMN 1.1, and the like. You can use this property to configure the {ENGINE} to support only pure DMN 1.1 features, such as when running the https://dmn-tck.github.io/tck/[DMN Technology Compatibility Kit] (TCK).
+
--
Default value: false

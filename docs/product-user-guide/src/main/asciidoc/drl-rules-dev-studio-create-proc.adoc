...
You can edit the existing sample rule and Java object files with new configurations as needed, or create new rule and object files. In this procedure, you are creating a new rule and a new Java object.
--
...
+
In the following example, the required imports are listed and a main class `RulesTest.java` is created:
+
[source,java]
----
package com.sample;

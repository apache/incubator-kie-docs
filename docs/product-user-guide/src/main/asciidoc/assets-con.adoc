...
Business Central provides a web front-end that enables you to view and update the stored content. You can access Knowledge Store assets in *Authoring -> Project Authoring -> Project Explorer* of Business Central.

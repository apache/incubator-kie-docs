...
For more information about creating Entando App Builder page models and pages, see "How to manage widgets, page models, and fragments" in Custom App Building with Entando 5.0.
//@link: Update link.

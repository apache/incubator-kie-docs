...
+
* *Metadata:* Enter a metadata label and click the plus icon (image:5686.png[]). Then enter any needed data in the field provided in the rule designer.
...
+
.Rule options
image::1141.png[Additional rule options]

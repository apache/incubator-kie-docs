...
To add the guarantor to the condition, first add the *guarantor* field to the application fact type (Data Object in Business Central) of the mortgage model. For further information about how to add a field to a fact type, see <<data_modeler_con>>.

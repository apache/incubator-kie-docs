...
*<@Michael (9 of 13): Can you just check my examples in the table? I've added them, and they'll apply to the other docs where this table is also used. I decided they're helpful to have.>*

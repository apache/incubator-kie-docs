...
An _<<guided-decision-tables-columns-work-item-con, Execute a Work Item>>_ column must already be created in the table for this column option to be created.

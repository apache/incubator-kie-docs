...
[NOTE]
====
To see and use this editor, the user needs to have the ``Resource Planner`` permission. For information about setting up permissions see the _Red Hat BPM Suite Administration and Configuration Guide_.
====

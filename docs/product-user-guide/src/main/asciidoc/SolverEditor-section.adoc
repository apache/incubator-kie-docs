...
[NOTE]
====
To see and use this editor, the user needs to have the ``Resource Planner`` permission. For information about setting up permissions see the {URL_ADMIN_GUIDE}[{ADMIN_GUIDE}].
====

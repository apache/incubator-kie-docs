...
Take note of the “namespace” and “name” attributes of the root “semantic” tag because these values uniquely identify this decision. Like much XML, the “namespace” value appears as a unique URL associated with the organization or individual that authored the document.

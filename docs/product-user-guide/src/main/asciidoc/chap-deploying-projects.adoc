...
COMMENT: How do I change an alias for a single project now?
...
After you have created, configured, and deployed your project comprising your business processes, you can view the list of all the process definitions in t*Menu* → *Manage* → *Process Definitions*.
...
The Process Instances view also has features such as auto refresh and restore default views. Auto refresh enables you to define how frequently the data grid refreshes. You can select a differenct value (1, 5 or 10 minutes), or disable this feature by clicking the *Disable* button:
...
* Access the *Task Administration List* by clicking *Menu* -> *Manage* -> *Task Administration*. It provides a full list of tasks across all processes.
+

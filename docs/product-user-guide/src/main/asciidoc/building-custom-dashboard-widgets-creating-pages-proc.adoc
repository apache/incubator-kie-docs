...
Using the KIE Workbench, you can create a page which will contain core, navigational, and reporting components as per your requirements. After a page has been created and all the components defined in it, you can use the *Content Manager* of the *Project Explorer* to save, delete, rename or copy pages as needed.

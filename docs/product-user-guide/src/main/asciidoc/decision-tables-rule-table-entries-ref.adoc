...
+
*<@Michael (5 of 6): Isn't this first cell also optional, like it is with Actions below? And shouldn't we say something similar to what we say for the first cell in the Actions section below?>*

...
For more information about using Entando App Builder widgets, see "How to manage widgets, page models, and fragments" in Custom App Building with Entando 5.0.
//@link: Update link.

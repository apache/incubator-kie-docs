...
* Entando App Builder 5.0 is installed. For instructions, see link:https://central.apps.entando.com/en/documentation.page[_Getting Started with Entando App Builder 5.0_].

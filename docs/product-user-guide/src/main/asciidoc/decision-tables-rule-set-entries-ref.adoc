...
|`RuleSet`
|The package name for the generated DRL file. Optional, the default is `rule_table`.  *<@Michael (2 of 5): This right? Seems odd that rule_table is the default name for the rule set.>*

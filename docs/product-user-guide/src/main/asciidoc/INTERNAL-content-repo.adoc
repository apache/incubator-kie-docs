...
The editor contains *Model*, *Overview*, *Source*, and *Data Objects* tabs.

.Editor Tab
The *Model* tab is where assets can be edited.
...
Describe initiating DM/PAM and Decision Server (kie-server) and using the swagger API interface to test calls.

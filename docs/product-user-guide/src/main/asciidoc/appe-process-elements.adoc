...
. In {CENTRAL}, open your project in the Project Editor and click *Project Settings: Project General Settings* -> *Deployment descriptor*.
...
From {PRODUCT} 6.2 onwards, JavaScript is supported as a dialect in Script Tasks. To define a Script Task in {CENTRAL} and JBoss Developer Studio using the process design tool:
...
.Script Task in {CENTRAL} using JavaScript
====

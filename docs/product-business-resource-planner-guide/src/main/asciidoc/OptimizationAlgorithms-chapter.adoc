...
[id='doesPlannerFindTheOptimalSolution']
...
[id='optimizationAlgorithmsOverview']
...
[id='whichOptimizationAlgorithmsShouldIUse']
...
[id='unimprovedTimeMillisSpentTermination']
...
[id='bestScoreFeasibleTermination']
...
[id='unimprovedStepCountTermination']
...
[id='scoreCalculationCountTermination']
...
[id='combiningMultipleTerminations']

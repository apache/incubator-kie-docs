[id='employeeRostering']
= Employee Rostering (INRC 2010 - Nurse Rostering)


[id='employeeRosteringProblemDescription']
== Problem Description
...
[id='employeeRosteringDomainModel']
== Domain Model

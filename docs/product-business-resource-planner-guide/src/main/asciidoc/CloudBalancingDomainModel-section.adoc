[id='cloudBalancingDomainModel']
= Using the Domain Model
:imagesdir: ../..


[id='cloudBalancingDomainModelDesign']
== Domain Model Design
...
[id='cloudBalancingDomainModelImplementation']
== Domain Model Implementation


[id='cloudBalancingClassComputer']
=== The `Computer` Class
...
[id='cloudBalancingClassCloudBalance']

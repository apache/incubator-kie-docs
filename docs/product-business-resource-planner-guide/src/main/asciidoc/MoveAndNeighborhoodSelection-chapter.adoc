[id='moveAndNeighborhoodSelection']
...
[id='moveAndNeighborhoodSelectionIntroduction']
...
[id='subselectingOfEntitiesValuesAndOtherMoves']
...
[id='genericMoveSelectors']
== Generic MoveSelectors


[id='changeMoveSelector']
=== changeMoveSelector
...
[id='combiningMultipleMoveSelectors']
== Combining Multiple ``MoveSelector``s


[id='unionMoveSelector']
=== unionMoveSelector
...
[id='cartesianProductMoveSelector']
...
[id='recommendedCombinationsOfCacheTypeAndSelectionOrder']
=== Recommended Combinations of `CacheType` and `SelectionOrder`


[id='justInTimeRandomSelection']
...
[id='sortedSelectionBySorterManner']
...
[id='sortedSelectionByComparator']
...
[id='sortedSelectionBySelectionSorterWeightFactory']
...
[id='sortedSelectionBySelectionSorter']
...
[id='whichMoveTypesMightBeMissing']

[id='machineReassignment']
= Machine Reassignment (Google ROADEF 2012)


[id='machineReassignmentProblemDescription']
== Problem Description
...
[id='machineReassignmentDomainModel']
== Domain Model

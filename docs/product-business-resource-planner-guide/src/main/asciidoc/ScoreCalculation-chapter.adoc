...
[id='formalizeTheBusinessConstraints']
...
[id='avoidFloatingPointNumbersInScoreCalculation']
...
[id='calculateTheScore']
== Calculate the `Score`


[id='scoreCalculationTypes']
...
[id='incrementalJavaScoreCalculation']
...
[id='constraintMatchAwareIncrementalScoreCalculator']
...
[id='droolsScoreCalculation']
=== Drools Score Calculation


[id='droolsScoreCalculationOverview']
==== Overview
...
[id='droolsScoreCalculationScoreDrlFile']
===== A scoreDrlFile
...
[id='droolsScoreCalculationKsessionName']
...
[id='scoreCalculationPerformanceTricks']
== Score Calculation Performance Tricks


[id='scoreCalculationPerformanceTricksOverview']
=== Overview
...
[id='incrementalScoreCalculation']
...
[id='avoidCallingRemoteServicesDuringScoreCalculation']
...
[id='otherScoreCalculationPerformanceTricks']

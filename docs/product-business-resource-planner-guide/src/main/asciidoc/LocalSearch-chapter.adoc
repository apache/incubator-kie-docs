...
[id='localSearchConcepts']
== Local Search Concepts


[id='localSearchStepByStep']
=== Step by Step
...
[id='localSearchConceptsDecideTheNextStep']
...
[id='hillClimbingStuckInLocalOptima']
...
[id='simulatedAnnealingAlgorithm']
=== Algorithm Description
...
[id='simulatedAnnealingConfiguration']
=== Configuration
...
[id='lateAcceptanceConfiguration']
=== Configuration
...
[id='stepCountingHillClimbing']
== Step Counting Hill Climbing


[id='stepCountingHillClimbingAlgorithm']
=== Algorithm Description
...
[id='stepCountingHillClimbingConfiguration']
=== Configuration
...
[id='strategicOscillation']
== Strategic Oscillation


[id='strategicOscillationAlgorithm']
=== Algorithm Description
...
[id='strategicOscillationConfiguration']
=== Configuration
...
[id='customTerminationSelectorOrAcceptor']

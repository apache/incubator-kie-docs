...
.Prerequisite
The team and project for the guided decision tables have been created in {CENTRAL}. Each asset is associated with a project assigned to a team.
...
include::product-user-guide/project-deploy-proc.adoc[leveloffset=+1]

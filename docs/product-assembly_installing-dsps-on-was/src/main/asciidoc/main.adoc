...
This document describes how to configure IBM WebSphere Application Server ({WEBSPHERE_SHORT}) for {KIE_SERVER} and how to install {KIE_SERVER} on {WEBSPHERE_SHORT}.
...
include::product-ibm-websphere-installation-and-configuration-guide/controller-download-extract-proc.adoc[leveloffset=+2]

include::product-ibm-websphere-installation-and-configuration-guide/controller-was-ev-set-proc.adoc[leveloffset=+2]

include::product-ibm-websphere-installation-and-configuration-guide/controller-install-was-proc.adoc[leveloffset=+2]
// Versioning info

...
include::product-ibm-websphere-installation-and-configuration-guide/kie-server-was-group-proc.adoc[leveloffset=+2]

include::product-ibm-websphere-installation-and-configuration-guide/kie-server-was-mapping-proc.adoc[leveloffset=+2]

include::product-ibm-websphere-installation-and-configuration-guide/was-ks-classloader-proc.adoc[leveloffset=+2]
...
include::product-ibm-websphere-installation-and-configuration-guide/was-controller-classloader-proc.adoc[leveloffset=+2]
...
//include::product-ibm-websphere-installation-and-configuration-guide/controller-was-group-proc.adoc[leveloffset=+2]

include::product-ibm-websphere-installation-and-configuration-guide/controller-was-mapping-proc.adoc[leveloffset=+2]

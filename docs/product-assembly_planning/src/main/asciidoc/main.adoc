...
With {PRODUCT}, you can set up a development environment to develop decision management applications, a runtime environment to run those applications to support decisions, or both.
...
* {URL_INSTALLING_ON_EAP}[_INSTALLING_ON_EAP_]
* {URL_INSTALLING_KIE_ON_WAS}[_INSTALLING_KIE_ON_WAS_]
* {URL_INSTALLING_KIE_ON_WLS}[_INSTALLING_KIE_ON_WLS_]
* {URL_INSTALLING_PLANNER}[_INSTALLING_PLANNER_]
* {URL_INSTALLING_ON_EAP_CLUSTER}[_INSTALLING_ON_EAP_CLUSTER_]
* {URL_INTEGRATING_JBDS}[_INTEGRATING_JBDS_]
* {URL_INTEGRATING_SSO}[_INTEGRATING_SSO_]
* {URL_DEPLOYING_AUTHORING_ON_OPENSHIFT}[_DEPLOYING_AUTHORING_ON_OPENSHIFT_]
* {URL_DEPLOYING_IMMUTABLE_ON_OPENSHIFT}[_DEPLOYING_IMMUTABLE_ON_OPENSHIFT_]
* {URL_DEPLOYING_MANAGED_ON_OPENSHIFT}[_DEPLOYING_MANAGED_ON_OPENSHIFT_]

...
.Prerequisites
* An {WEBLOGIC} instance version 12.2.1.3.0 or later is installed. For complete installation instructions, visit the http://www.oracle.com/technetwork/middleware/weblogic/documentation/index.html[{WEBLOGIC} product page].

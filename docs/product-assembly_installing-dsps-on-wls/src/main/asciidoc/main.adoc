...
.Prerequisites
* An {WEBLOGIC} instance is installed (release 12.2.1.3.0 or later). For complete installation instructions, visit the http://www.oracle.com/technetwork/middleware/weblogic/documentation/index.html[{WEBLOGIC} documentation page].
* You have access to the {WEBLOGIC} Administration Console, usually at `http://<TARGET_SERVER>:7001/console`.

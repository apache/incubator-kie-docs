...
A {PRODUCT} project running in {PRODUCT} could be configured to be stateless of stateful. A project that has already been deployed on a Decision Server xPaaS image will be configured to be stateless.

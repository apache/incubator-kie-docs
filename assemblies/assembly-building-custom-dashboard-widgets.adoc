...
As a business analyst or business rules developer, use the *Page Editor* to design and define custom pages. You can create static pages or pages that contain dynamic reporting components. These pages are called dashboard pages. You can customize the component properties of a page according to your requirements. Optionally, before you create a dashboard page, you can define a data set to feed the reporting components. You can export dashboard pages to the standalone Dashbuilder Runtime viewer for on premise installations or the Dashbuilder Standalone viewer on {OPENSHIFT}.

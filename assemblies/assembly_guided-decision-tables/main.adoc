...
include::{enterprise-dir}/rules/guided-decision-tables-create-proc.adoc[leveloffset=+1]

include::{enterprise-dir}/rules/guided-decision-tables-hit-policies-con.adoc[leveloffset=+1]

include::{enterprise-dir}/rules/guided-decision-tables-hit-policies-examples-ref.adoc[leveloffset=+2]

include::{enterprise-dir}/rules/guided-decision-tables-types-con.adoc[leveloffset=+3]

include::{enterprise-dir}/rules/guided-decision-tables-columns-create-proc.adoc[leveloffset=+1]

include::{enterprise-dir}/rules/guided-decision-tables-columns-types-con.adoc[leveloffset=+1]

include::{enterprise-dir}/rules/guided-decision-tables-columns-edit-proc.adoc[leveloffset=+1]

include::{enterprise-dir}/rules/guided-decision-tables-rows-create-proc.adoc[leveloffset=+1]

include::{enterprise-dir}/rules/guided-decision-tables-validation-con.adoc[leveloffset=+1]

include::{enterprise-dir}/rules/guided-decision-tables-errors-ref.adoc[leveloffset=+2]

include::{enterprise-dir}/rules/guided-decision-tables-messages-ref.adoc[leveloffset=+2]

include::{enterprise-dir}/rules/guided-decision-tables-validation-disable-proc.adoc[leveloffset=+2]

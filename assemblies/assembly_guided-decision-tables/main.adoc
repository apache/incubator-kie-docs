...
.Prerequisites
* The space and project for the guided decision tables have been created in {CENTRAL}. Each asset is associated with a project assigned to a team. For details, see {URL_GETTING_STARTED_DECISION_SERVICE}[_{GETTING_STARTED_DECISION_SERVICE}_].

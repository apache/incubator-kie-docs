...
= Creating {PRODUCT_BA} business applications with Spring Boot
...
As a developer, you can use Spring Boot starters, through the https://start.jbpm.org[start.jbpm.org] web site, to quickly create {PRODUCT_BA} business applications, configure those applications, and deploy them to an existing service or in the cloud.

...
include::{enterprise-dir}/openshift/rhdm77-authoring-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm77-authoring-ha-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm77-kieserver-ref.adoc[leveloffset=+2]

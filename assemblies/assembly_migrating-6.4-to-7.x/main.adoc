...
* A clean {PRODUCT} {PRODUCT_VERSION} installation exists that does not contain a `.niogit` folder. If the {PRODUCT} {PRODUCT_VERSION} installation contains a `.niogit` folder, the installation will fail. For installation options, see {URL_PLANNING_INSTALL}[_{PLANNING_INSTALL}_].

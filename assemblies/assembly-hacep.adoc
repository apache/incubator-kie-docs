...
* A {OPENSHIFT} {OPENSHIFT_VERSION_SHORT} environment is available. For the exact versions of {OPENSHIFT} that the current release supports, see https://www.ibm.com/support/pages/node/6596919[{PRODUCT} 8 system requirements].

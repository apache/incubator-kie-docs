...
ifdef::PAM[]
https://access.redhat.com/documentation/en-us/red_hat_process_automation_manager/7.2/html-single/patching_and_upgrading_red_hat_process_automation_manager_7.2/[_Patching and upgrading {PRODUCT} 7.2_]
endif::[]
ifdef::DM[]
https://access.redhat.com/documentation/en-us/red_hat_decision_manager/7.2/html-single/patching_and_upgrading_red_hat_decision_manager_7.2/[_Patching and upgrading {PRODUCT} 7.2_]
endif::[]

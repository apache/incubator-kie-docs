...
ifdef::PAM[]
https://access.redhat.com/documentation/en-us/red_hat_process_automation_manager/7.1/html-single/patching_and_upgrading_red_hat_process_automation_manager_7.1/[Patching and upgrading {PRODUCT} 7.1]
endif::[]
ifdef::DM[]
https://access.redhat.com/documentation/en-us/red_hat_decision_manager/7.1/html-single/patching_and_upgrading_red_hat_decision_manager_7.1/[Patching and upgrading {PRODUCT} 7.1]
endif::[]

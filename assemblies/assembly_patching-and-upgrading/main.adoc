...
+
NOTE: If you are using {PRODUCT} 7.3 and you want to upgrade to {PRODUCT} {PRODUCT_VERSION}, see
ifdef::PAM[]
https://access.redhat.com/documentation/en-us/red_hat_process_automation_manager/7.3/html-single/patching_and_upgrading_red_hat_process_automation_manager_7.3/[_Patching and upgrading {PRODUCT} 7.3_]
endif::[]
ifdef::DM[]
https://access.redhat.com/documentation/en-us/red_hat_decision_manager/7.3/html-single/patching_and_upgrading_red_hat_decision_manager_7.3/[_Patching and upgrading {PRODUCT} 7.3_]
endif::[]
...
include::{enterprise-dir}/migration/migration-tool-niogit-7.4-proc.adoc[leveloffset=+1]

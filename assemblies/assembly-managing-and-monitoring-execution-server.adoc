...
[NOTE]
====
For information about managing and monitoring business processes that run on {KIE_SERVER}, see {URL/DEVELOPING_PROCESS_SERVICES}#assembly-managing-and-monitoring-business-processes[_{MANAGING_PROCESSES}_].
====
endif::PAM[]

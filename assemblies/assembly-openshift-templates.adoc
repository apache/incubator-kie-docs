...
ifdef::PAM[]
include::{enterprise-dir}/openshift/rhpam711-trial-ephemeral-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam711-authoring-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam711-authoring-ha-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam711-prod-immutable-monitor-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam711-prod-immutable-kieserver-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam711-prod-immutable-kieserver-amq-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam711-kieserver-externaldb-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam711-kieserver-mysql-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam711-kieserver-postgresql-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam711-managed-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam711-prod-ref.adoc[leveloffset=+2]
endif::PAM[]
ifdef::DM[]
include::{enterprise-dir}/openshift/rhdm711-trial-ephemeral-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm711-authoring-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm711-authoring-ha-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm711-kieserver-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm711-prod-immutable-kieserver-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm711-prod-immutable-kieserver-amq-ref.adoc[leveloffset=+2]
endif::DM[]

...
ifdef::PAM[]
include::{enterprise-dir}/openshift/rhpam79-trial-ephemeral-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam79-authoring-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam79-authoring-ha-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam79-prod-immutable-monitor-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam79-prod-immutable-kieserver-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam79-prod-immutable-kieserver-amq-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam79-kieserver-externaldb-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam79-kieserver-mysql-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam79-kieserver-postgresql-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam79-managed-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam79-prod-ref.adoc[leveloffset=+2]
endif::PAM[]
ifdef::DM[]
include::{enterprise-dir}/openshift/rhdm79-trial-ephemeral-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm79-authoring-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm79-authoring-ha-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm79-kieserver-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm79-prod-immutable-kieserver-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm79-prod-immutable-kieserver-amq-ref.adoc[leveloffset=+2]
endif::DM[]

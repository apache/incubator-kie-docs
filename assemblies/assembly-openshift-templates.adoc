...
= Deploying a {PRODUCT} environment on {OPENSHIFT} version 3 using templates
ifdef::context[:parent-context: {context}]
// Context attribute is assembly specific and enables module reuse between assemblies.
:context: openshift-templates

// Purpose statement for the assembly
As a system engineer, you can deploy a {PRODUCT} environment on {OPENSHIFT} version 3 to provide an infrastructure to develop or execute
ifdef::DM[]
services
endif::DM[]
ifdef::PAM[]
...
[NOTE]
====
For instructions about deploying a {PRODUCT} environment on {OPENSHIFT} version 4 using Operators, see {URL_DEPLOYING_ON_OPENSHIFT}#assembly-openshift-operator[_{DEPLOYING_OPENSHIFT_OPERATOR}_].
====

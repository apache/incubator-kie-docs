...
= Deploying an {PRODUCT} environment on {OPENSHIFT} {OPENSHIFT_VERSION_SHORT_OLD} using templates
ifdef::context[:parent-context: {context}]
// Context attribute is assembly specific and enables module reuse between assemblies.
:context: openshift-templates

// Purpose statement for the assembly
As a system engineer, you can deploy an {PRODUCT} environment on {OPENSHIFT} {OPENSHIFT_VERSION_SHORT_OLD} to provide an infrastructure to develop or execute
ifdef::DM[]
services
endif::DM[]
ifdef::PAM[]
...
ifdef::PAM[]
include::{enterprise-dir}/openshift/rhpam712-trial-ephemeral-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam712-authoring-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam712-authoring-ha-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam712-prod-immutable-monitor-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam712-prod-immutable-kieserver-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam712-prod-immutable-kieserver-amq-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam712-kieserver-externaldb-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam712-kieserver-mysql-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam712-kieserver-postgresql-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam712-managed-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam712-prod-ref.adoc[leveloffset=+2]
endif::PAM[]
ifdef::DM[]
include::{enterprise-dir}/openshift/rhdm712-trial-ephemeral-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm712-authoring-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm712-authoring-ha-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm712-kieserver-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm712-prod-immutable-kieserver-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm712-prod-immutable-kieserver-amq-ref.adoc[leveloffset=+2]
endif::DM[]

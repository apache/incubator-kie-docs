...
include::{drools-dir}/PMML/pmml-naming-conventions-legacy-ref.adoc[leveloffset=+2]

include::{drools-dir}/PMML/pmml-naming-conventions-trusty-ref.adoc[leveloffset=+2]

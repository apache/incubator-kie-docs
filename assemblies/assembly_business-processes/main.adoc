...
* If you are migrating a business process from the new process designer in {CENTRAL} to the legacy process designer, see <<_interacting_with_processes_migrating_process_designer_proc>>.

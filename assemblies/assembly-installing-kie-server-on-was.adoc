...
[NOTE]
====
Support for {PRODUCT} on {WEBSPHERE} is now in the maintenance phase. IBM will continue to support {PRODUCT} on {WEBSPHERE} with the following limitations:

* IBM will not release new certifications or software functionality.
* IBM will release only qualified security patches that have a critical impact and mission-critical bug fix patches.

In the future, IBM might direct customers to migrate to new platforms and product components that are compatible with the IBM hybrid cloud strategy.
====
////

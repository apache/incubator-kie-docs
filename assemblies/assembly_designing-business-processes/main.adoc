...
include::{jbpm-dir}/BPMN2/design-business-process-proc.adoc[leveloffset=+2]
...
include::{enterprise-dir}/bpmn/bpmn-user-task-lifecycle-ref.adoc[leveloffset=+1]
include::{enterprise-dir}/bpmn/bpmn-user-task-permission-ref.adoc[leveloffset=+1]
...
include::{jbpm-dir}/BPMN2/dmn-execution-business-process.adoc[leveloffset=+1]

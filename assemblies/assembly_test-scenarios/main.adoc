...
include::{drools-dir}/AuthoringAssets/test-designer-delete-test-proc.adoc[leveloffset=+2]
include::{drools-dir}/AuthoringAssets/test-designer-rename-test-proc.adoc[leveloffset=+2]

...
This document describes how to install {PRODUCT} {PRODUCT_VERSION} on JBoss Web Server 5.0.1 or higher.
...
ifdef::PAM[]
include::{enterprise-dir}/installation/jws-jdbc-config_proc.adoc[leveloffset=+1]
endif::PAM[]

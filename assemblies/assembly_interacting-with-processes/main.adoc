...
.Prerequisites
* Installed {PRODUCT} on Red Hat JBoss Enterprise Application Platform 7.1.x. For more information, see {URL_INSTALLING_ON_EAP}[_{INSTALLING_ON_EAP}_].
...
include::{enterprise-dir}/processes/interacting-with-processes-viewing-history-log-proc.adoc[leveloffset=+1]

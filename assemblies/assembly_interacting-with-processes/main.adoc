...
include::{enterprise-dir}/processes/interacting-with-processes-starting-stopping-tasks-proc.adoc[leveloffset=+2]

include::{enterprise-dir}/processes/interacting-with-processes-delegating-claiming-releasing-tasks-proc.adoc[leveloffset=+2]
...
include::{enterprise-dir}/processes/interacting-with-processes-viewing-history-log-proc.adoc[leveloffset=+2]

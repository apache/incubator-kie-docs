[id='assembly_business-optimizer-vrp']

include::_artifacts/document-attributes.adoc[]

= Deploying and using the vehicle route planning starter application for {PLANNER}
...
As a developer, you can use the OptaWeb Vehicle Routing vehicle route planning starter application to optimize your vehicle fleet deliveries.
...
include::{enterprise-dir}/vehicle-route-planning/run-locally-airdistance-proc.adoc[leveloffset=+2]
...
include::{enterprise-dir}/vehicle-route-planning/vrp-run-openshift.adoc[leveloffset=+1]

include::{enterprise-dir}/vehicle-route-planning/vrp-update-deployed-changes.adoc[leveloffset=+2]
...
include::{enterprise-dir}/vehicle-route-planning/vrp-create-route.adoc[leveloffset=+2]

include::{enterprise-dir}/vehicle-route-planning/vrp-other-actions-proc.adoc[leveloffset=+2]
include::{enterprise-dir}/vehicle-route-planning/vrp-custom-data-sets.adoc[leveloffset=+2]
include::{enterprise-dir}/vehicle-route-planning/vrp-troubleshooting.adoc[leveloffset=+2]



== OptaWeb Vehicle Routing development guide
This section shows you how to configure and run the back and front end modules in development mode.

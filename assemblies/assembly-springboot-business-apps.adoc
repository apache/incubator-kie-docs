...
As a developer, you can use Spring Boot starters through the maven archetype commands to quickly create {PRODUCT} business applications, configure those applications, and deploy them to an existing service or in the cloud.

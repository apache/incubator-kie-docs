...
* `Roles`: View and set the home page, priority, and permissions of a role.
* `Groups`: View and set the home page, priority, and permissions of a group as well as view, create, and delete groups.
* `Users`: View, create, and delete users as well as add a group, role to a user and view its permissions.

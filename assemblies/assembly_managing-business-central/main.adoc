...
* `Groups`: View and set home page, priority, and permissions of a group. You can also view, create, and delete groups using this setting.
* `Users`: View, create, and delete users using this setting. You can also add a group, role and view the permissions of a user.

...
ifdef::PAM[]
include::{enterprise-dir}/openshift/rhpam77-trial-ephemeral-ref.adoc[leveloffset=+2]
endif::PAM[]
ifdef::DM[]
include::{enterprise-dir}/openshift/rhdm77-trial-ephemeral-ref.adoc[leveloffset=+2]
endif::DM[]

...
//xreflink
* {PRODUCT} is running and you can log in to {CENTRAL} with the `kie-server` and `user` roles. *<MH>Cristaino, should the role be as shown here or as the `developer` role?</MH>*

...
[NOTE]
====
Support for {PRODUCT} on {EAP} and Apache Tomcat is now in the maintenance phase. Red Hat will continue to support {PRODUCT} on these platforms with the following limitations:

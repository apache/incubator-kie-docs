...
+
NOTE: If you are using {PRODUCT} 7.8 and you want to upgrade to {PRODUCT} {PRODUCT_VERSION}, see
ifdef::PAM[]
https://access.redhat.com/documentation/en-us/red_hat_process_automation_manager/7.8/html-single/patching_and_upgrading_red_hat_process_automation_manager_7.8/[_Patching and upgrading {PRODUCT} 7.8_]
endif::[]
ifdef::DM[]
https://access.redhat.com/documentation/en-us/red_hat_decision_manager/7.8/html-single/patching_and_upgrading_red_hat_decision_manager_7.8/[_Patching and upgrading {PRODUCT} 7.8_]
endif::[]
.

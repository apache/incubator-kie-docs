...
+
NOTE: If you are using {PRODUCT} 7.9 and you want to upgrade to {PRODUCT} {PRODUCT_VERSION}, see
ifdef::PAM[]
https://access.redhat.com/documentation/en-us/red_hat_process_automation_manager/7.9/html-single/installing_and_configuring_red_hat_process_automation_manager/index#assembly-patching-and-upgrading[_Patching and upgrading {PRODUCT} 7.9_]
endif::[]
ifdef::DM[]
https://access.redhat.com/documentation/en-us/red_hat_decision_manager/7.9/html-single/installing_and_configuring_red_hat_decision_manager/index#assembly-patching-and-upgrading[_Patching and upgrading {PRODUCT} 7.9_]
endif::[]
.

...
As an {PRODUCT} user, you can apply updates to {PRODUCT} as they become available in the Red Hat Customer Portal to keep your {PRODUCT} distribution current with the latest enhancements and fixes. Red Hat provides update tools and product notifications for new product releases so you can more readily apply helpful updates to {PRODUCT} and {KIE_SERVER}.
...
+
NOTE: If you are using {PRODUCT} 7.10 and you want to upgrade to {PRODUCT} {PRODUCT_VERSION}, see
ifdef::PAM[]

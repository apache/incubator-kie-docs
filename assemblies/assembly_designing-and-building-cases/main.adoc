...
.Prerequisites
* {EAP_LONG} {PRODUCT_VERSION} installed. See  https://access.redhat.com/documentation/en-us/red_hat_jboss_enterprise_application_platform/7.3/html-single/installation_guide/[_Red Hat JBoss EAP 7.3.0 Installation Guide_].
...
* The Showcase application is deployed. For information about how to install and log in to Showcase, see {URL_SHOWCASE_APPLICATION_CASE_MANAGEMENT}[_{SHOWCASE_APPLICATION_CASE_MANAGEMENT}_].

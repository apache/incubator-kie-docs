...
.Prerequisites
* {EAP_LONG} {PRODUCT_VERSION} is installed. For information about installing {EAP_LONG} {PRODUCT_VERSION}, see https://access.redhat.com/documentation/en-us/red_hat_jboss_enterprise_application_platform/7.3/html-single/installation_guide/[_Red Hat JBoss EAP 7.3.0 Installation Guide_].

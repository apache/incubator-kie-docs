...
* The Showcase application is deployed. For information about how to install and log in to Showcase, see {URL_SHOWCASE_APPLICATION_CASE_MANAGEMENT}[_{USING_THE_SHOWCASE_APPLICATION_FOR_CASE_MANAGEMENT}_].

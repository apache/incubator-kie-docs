...
* `KieLoginModule` is configured in `standalone-full.xml`. This required to connect to {KIE_SERVER}. For more information about configuring {KIE_SERVER}, see {URL_INSTALLING_AND_CONFIGURING}#assembly-planning[_{PLANNING_INSTALL}_].

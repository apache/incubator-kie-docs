...
|state |State |String
|city |City |String
|violations |Violations |Violation (org.jboss.example.traffic_violations.Violation) Note: The violations field is set to "List" to hold multiple item for the given type.
|fineAmount |Fine Amount |Double

...
+
Complete spring configuration file can be found https://github.com/droolsjbpm/droolsjbpm-integration/blob/master/kie-spring/src/test/resources/jbpm/jta-emf/jta-emf-spring.xml[here].

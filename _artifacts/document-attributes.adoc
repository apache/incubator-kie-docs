...
:CODEREADY_STUDIO_VERSION: 12.16
:CODEREADY_STUDIO_VERSION_LONG: 12.16.0
...
:CREATING_SPRING_BOOT_APPLICATIONS: Using {PLANNER} with Spring Boot to create a school timetable

...
:REBUILT: Wednesday, April 22, 2020

:COMMUNITY_VERSION: 0.10
...
:COMMUNITY_VERSION_BRANCH: 0.10.x
...
:URL_BASE_ENTERPRISE: ftp://partners.redhat.com/f1b4846876232d22082b7f2d5c5d3b7b/kogito/devpreview1/documentation

// URLs for assemblies for Dev Preview (FTP)

:URL_RELEASE_NOTES: {URL_BASE_ENTERPRISE}/Kogito-0.9-Release_notes_for_Kogito_0.9-en-US.pdf
:URL_CREATING_RUNNING: {URL_BASE_ENTERPRISE}/Kogito-0.9-Creating_and_running_your_first_Kogito_services-en-US.pdf
:URL_DEPLOYING_ON_OPENSHIFT: {URL_BASE_ENTERPRISE}/Kogito-0.9-Deploying_Kogito_services_on_Red_Hat_OpenShift_Container_Platform-en-US.pdf
:URL_DECISION_SERVICES: {URL_BASE_ENTERPRISE}/Kogito-0.9-Developing_decision_services_with_Kogito-en-US.pdf
:URL_PROCESS_SERVICES: {URL_BASE_ENTERPRISE}/Kogito-0.9-Developing_process_services_with_Kogito-en-US.pdf
:URL_CONFIGURING_KOGITO: {URL_BASE_ENTERPRISE}/Kogito-0.9-Configuring_Kogito_supporting_services_and_runtime_capabilities-en-US.pdf

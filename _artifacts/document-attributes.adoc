...
:REBUILT: Wednesday, May 4, 2022


:ENTERPRISE_VERSION: 8.0
:ENTERPRISE_VERSION_LONG: 8.0
...
>>>>>>> f90c4405d (BXMSDOC-8547-blue fixed doc attributes build issue)
// For copyright
:YEAR: 2022
...
:QUARKUS_VERSION_LONG: 2..7.5
:QUARKUS_BOM: {QUARKUS_VERSION_LONG}.Final-redhat-00011
...
:PLANNING_INSTALL: Planning a {PRODUCT}

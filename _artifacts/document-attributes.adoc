...
:DEPLOYING_OPENSHIFT_OPERATOR: Deploying a {PRODUCT} environment on {OPENSHIFT} version 4 using Operators
:DEPLOYING_OPENSHIFT_TEMPLATES: Deploying a {PRODUCT} environment on {OPENSHIFT} version 3 using templates

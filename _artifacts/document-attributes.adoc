...
:CONFIGURING_CENTRAL_SETTINGS_PROPERTIES: Configuring {CENTRAL} settings and properties
...
:URL_CONFIGURING_CENTRAL_SETTINGS_PROPERTIES: {URL_BASE_ENTERPRISE}/configuring_{URL_COMPONENT_CENTRAL_UNDER}_settings_and_properties

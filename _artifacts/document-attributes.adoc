...
:INTEGRATING_ENTANDO: Integrating {PRODUCT} assets in Entando App Builder
...
:URL_INTEGRATING_ENTANDO: {URL_BASE_ENTERPRISE}/integrating_{URL_COMPONENT_PRODUCT}_assets_in_entando_app_builder

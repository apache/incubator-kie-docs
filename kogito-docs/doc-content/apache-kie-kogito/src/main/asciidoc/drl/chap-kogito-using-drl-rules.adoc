...
ifeval::["{context}" == "kogito-decision-engine"]
...
ifeval::["{context}" == "kogito-drl-rules"]
...
For more information about using data sources for rule actions, see xref:con-drl-rule-units_kogito-drl-rules[].
...
* xref:con-drl-rule-units_kogito-drl-rules[]
* xref:con-drl-rules-conditions_kogito-drl-rules[]
* xref:con-drl-rules-actions_kogito-drl-rules[]

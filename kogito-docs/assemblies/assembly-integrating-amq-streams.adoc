...
* https://access.redhat.com/documentation/en-us/red_hat_amq/{AMQ_URL_QUARTERLY}/html/using_amq_streams_on_openshift/[_Using AMQ Streams on OpenShift_]
* https://access.redhat.com/documentation/en-us/red_hat_amq/{AMQ_URL_QUARTERLY}/html/using_amq_streams_on_rhel/[_Using AMQ Streams on RHEL_]

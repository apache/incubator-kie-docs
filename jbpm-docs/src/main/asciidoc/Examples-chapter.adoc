...
The project, together with many other example projects, can be imported through https://github.com/droolsjbpm/jbpm-playground[github].
...
This section shows different examples that can be found in the jbpm-playground repository (also available here: https://github.com/droolsjbpm/jbpm-playground). All these examples are high level and business oriented. 

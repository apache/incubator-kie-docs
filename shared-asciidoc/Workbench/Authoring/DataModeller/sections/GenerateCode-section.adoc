...
image::shared/Workbench/Authoring/DataModeller/6.3/save_top.jpg[align="center"]
...
image::shared/Workbench/Authoring/DataModeller/6.3/generate-purchase-example.png[align="center"]

...
As you can see, a permission is a `resource + action` pair. In the concrete case of a perspective we have: _read_, _update_, _delete_ and _create_ as the available actions. That means that there are four possible permissions that could be granted for perspectives.
...
The Security Management perspective is available under the _Home_ section in the top menu bar.
...
image::shared/Workbench/SecurityManagement/SecurityManagementUsersExplorer.png[]
...
image::shared/Workbench/SecurityManagement/SecurityManagementUsersSearch.png[]
...
image::shared/Workbench/SecurityManagement/SecurityManagementNewUserForm.png[]
...
image::shared/Workbench/SecurityManagement/SecurityManagementViewUser.png[]

Same screen but when using the Keycloak security provider looks as:


image::shared/Workbench/SecurityManagement/SecurityManagementViewUserKC.png[]
...
image::shared/Workbench/SecurityManagement/SecurityManagementEditUser.png[]
...
image::shared/Workbench/SecurityManagement/SecurityManagementUserPermissions.png[]
...
image::shared/Workbench/SecurityManagement/SecurityManagementUserAttributes.png[]
...
image::shared/Workbench/SecurityManagement/SecurityManagementGroupsSelection.png[]
...
image::shared/Workbench/SecurityManagement/SecurityManagementRolesSelection.png[]
...
image::shared/Workbench/SecurityManagement/SecurityManagementChangePassword.png[]

* *Deleting users*
+
The user currently being edited can be deleted from the realm by clicking on the _Delete_ button.

image::shared/Workbench/SecurityManagement/SecurityManagementDeleteUser.png[]
...
image::shared/Workbench/SecurityManagement/SecurityManagementGroupsExplorer.png[]
...
image::shared/Workbench/SecurityManagement/SecurityManagementGroupsSearch.png[]
...
image::shared/Workbench/SecurityManagement/SecurityManagementNewGroup.png[]

After typing a name anc clicking _Save_, the next step is to assign users to it:
+

image::shared/Workbench/SecurityManagement/SecurityManagementNewGroupUserSelection.png[]
...
image::shared/Workbench/SecurityManagement/SecurityManagementRolesExplorer.png[]
...
image::shared/Workbench/SecurityManagement/SecurityManagementEditRole.png[]
...
image::shared/Workbench/SecurityManagement/SecurityManagementRolesSearch.png[]
...
image::shared/Workbench/SecurityManagement/SecurityManagementSecuritySettsEditor.png[]
+
...
For perspectives, organizational units, repositories and projects it is possible to define global permissions and add single instance exceptions afterwards. For instance,
_Read_ access can be granted to all the perspectives and deny access just to an individual perspective. This is called the _grant all deny a few_ strategy.

image::shared/Workbench/SecurityManagement/SecurityManagementPerspectiveDenied.png[]

The opposite, _deny all grant a few_ strategy is also supported:

image::shared/Workbench/SecurityManagement/SecurityManagementPerspectiveGranted.png[]

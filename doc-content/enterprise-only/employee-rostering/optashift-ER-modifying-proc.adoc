...
+
Use the Drools language for the rules. For reference information about the Drools rule language, see {URL_DRL_RULES}#drl-rules-con_drl-rules[_{DRL_RULES}_]. Classes defined in the `optaweb-employee-rostering-backend` modules are available to the {DECISION_ENGINE}.

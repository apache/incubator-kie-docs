...
You can run the Employee Rostering starter application from a JAR file included in the *{PRODUCT} {PRODUCT_VERSION} Decision Services Quick Starts* download.
...
.Procedure
. In a command terminal, change to the `kogito-1.5.0-decision-services-quickstarts/optaweb-8.5.0.Final-redhat-00001/optaweb-employee-rostering` directory.
...
. Navigate to the `kogito-1.5.0-decision-services-quickstarts/optaweb-8.5.0.Final-redhat-00001/optaweb-employee-rostering/optaweb-employee-rostering-standalone/target` directory.

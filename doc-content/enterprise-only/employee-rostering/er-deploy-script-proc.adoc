...
. Download the `{PRODUCT_FILE}-decision-services-quickstarts.zip` file from the {PRODUCT_DOWNLOAD_LINK}[Software Downloads] page of the Red Hat Customer Portal.
. Expand the downloaded archive.

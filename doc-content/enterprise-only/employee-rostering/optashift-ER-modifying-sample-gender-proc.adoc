...
. In the `optaweb-employee-rostering-server` package, in the `src/main/java/org/optaplanner/openshift/employeerostering/server/roster/RosterGenerator.java` class, add generation of gender when generating employees.

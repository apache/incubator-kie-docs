...
You can deploy the Employee Rostering starter application to {OPENSHIFT} using an OpenShift template or using the `runOnOpenShift.sh` shell script that is provided in the *{PRODUCT} {PRODUCT_VERSION} Decision Services Quick Starts* distribution.

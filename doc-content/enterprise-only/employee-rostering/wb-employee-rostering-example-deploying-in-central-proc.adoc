...
* You have started the {KIE_SERVER} and logged in to {CENTRAL} with a user that has `admin` permissions. For more information about getting started, see  {URL_BASE_ENTERPRISE}/getting_started_with_red_hat_decision_manager#assembly-getting-started-decision-services[_{GETTING_STARTED_DECISION_SERVICE}_].

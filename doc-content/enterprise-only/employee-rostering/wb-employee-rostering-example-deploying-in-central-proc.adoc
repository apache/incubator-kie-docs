...
* You have started {PRODUCT} as described the installation documentation that you used and you are logged in to {CENTRAL} with a user that has `admin` permissions.

...
= Disabling Spring Security in an {PRODUCT} business application
You can configure Spring Security in an {PRODUCT} business application to provide the security context without authentication.
//Why would I want to do this?

.Prerequisites
* You have an {PRODUCT} Spring Boot application.

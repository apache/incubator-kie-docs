...
The Java Persistence API (JPA) is a standard technology that enables you to map objects to relational databases. You must configure JPA for your Process Automation Manager business application.

.Prerequisites
* You have a Process Automation Manager `<business-application>.zip` file that you created using the http://start.jbpm.org[business applications]  web site.

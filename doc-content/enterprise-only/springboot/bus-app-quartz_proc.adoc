...
.Prerequisites
* You have a Spring Boot business application service that you created using the maven archetype command in <<_sect_BA_create_application, Create your business application section>> section and you want to use this application in a cluster.

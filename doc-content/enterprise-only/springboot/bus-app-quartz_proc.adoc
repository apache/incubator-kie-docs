...
.Prerequisites
* You have a Spring Boot business application service that you created using the maven archetype command in Create your business application section and you want to use this application in a cluster.

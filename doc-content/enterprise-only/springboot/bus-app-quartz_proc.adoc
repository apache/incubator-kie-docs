...
.Prerequisites
* You have a business application that you created using the http://start.jbpm.org[business application] website and you want to use this application in a cluster.

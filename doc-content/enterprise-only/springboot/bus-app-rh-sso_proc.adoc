...
[source]
----
import org.rhsso.adapters.RhssoConfigResolver;
import org.rhsso.adapters.springboot.RhssoSpringBootConfigResolver;
import org.rhsso.adapters.springsecurity.authentication.RhssoAuthenticationProvider;
import org.rhsso.adapters.springsecurity.config.RhssoWebSecurityConfigurerAdapter;
...
@EnableWebSecurity
public class DefaultWebSecurityConfig extends RhssoWebSecurityConfigurerAdapter {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        RhssoAuthenticationProvider rhssoAuthenticationProvider = rhssoAuthenticationProvider();
        SimpleAuthorityMapper mapper = new SimpleAuthorityMapper();
        mapper.setPrefix("");
        rhssoAuthenticationProvider.setGrantedAuthoritiesMapper(mapper);
        auth.authenticationProvider(rhssoAuthenticationProvider);
    }

    @Bean
    public RhssoConfigResolver RhssoConfigResolver() {
       return new RhssoSpringBootConfigResolver();
    }

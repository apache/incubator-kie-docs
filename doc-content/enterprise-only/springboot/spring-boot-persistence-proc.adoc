...
* For more information about persistence, see the "_Persisting process variables in a separate database schema in Red Hat Process Automation Manager_" section in {URL_MANAGING_SETTINGS}#process-variables-persist-proc_execution-server[_{MANAGING_KIE_SERVER}_].

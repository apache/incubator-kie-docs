...
.Procedure
. Extract the `<BUSINESS-APPLICATION>.zip` file and navigate to the `<BUSINESS-APPLICATION>/<BUSINESS-APPLICATION>-service` folder, where `<BUSINESS-APPLICATION>` is the name of your Spring Boot project.

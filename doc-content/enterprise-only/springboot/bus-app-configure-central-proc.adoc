...
If you selected *Business Automation* when you created your Spring Boot business application, you can specify which {CENTRAL} components to start at runtime.

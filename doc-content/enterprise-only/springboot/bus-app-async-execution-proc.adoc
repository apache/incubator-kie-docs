...
.Prerequisites
* You have a Spring Boot business application service file that you created using the maven archetype command. Please refer <<_sect_BA_create_application, Create your business application section>>.

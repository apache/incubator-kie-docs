...
You can import a business assets project that is part of an {PRODUCT} business application into {CENTRAL} and then deploy that project to a business application.

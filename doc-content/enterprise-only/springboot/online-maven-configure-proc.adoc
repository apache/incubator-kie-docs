...
= Configuring a business application for the online Maven repository
After you create your {PRODUCT} Spring Boot application, configure it with the online Maven Repository to store your application data.

.Prerequisites
* You have created a {PRODUCT} Spring Boot application.

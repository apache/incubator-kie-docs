...
WARNING: Starting with release {ENTERPRISE_VERSION_LONG}, {PRODUCT} no longer includes entitlements for Entando AppBuilder. Support for Entando AppBuilder is deprecated and it will be removed in a future release.

...
. Download *Red Hat Single Sign-on {RH-SSO_VERSION_LONG} Client Adapter for JBoss EAP 7* (`rh-sso-{RH-SSO_VERSION_LONG}-eap7-adapter.zip`).
. Extract and install `rh-sso-{RH-SSO_VERSION_LONG}-eap7-adapter.zip`. For installation instructions, see the "JBoss EAP Adapter" section of the https://access.redhat.com/documentation/en-us/red_hat_single_sign-on/{RH-SSO_VERSION}/html-single/securing_applications_and_services_guide/#jboss_adapter[_Red Hat Single Sign On Securing Applications and Services Guide_].
...
>>>>>>> b9393354... Merge pull request #209 from emmurphy1/BXMSDOC-4454-master
----
+
For example:
+

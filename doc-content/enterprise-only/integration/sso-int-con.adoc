...
To facilitate LDAP integration with {PRODUCT}, consider using RH-SSO with LDAP. For information, see the "LDAP and Active Directory" chapter of the https://access.redhat.com/documentation/en-us/red_hat_single_sign-on/{RH-SSO_VERSION}/html-single/server_administration_guide[_Red Hat Single Sign-On Server Administration Guide_].

...
. Download *Red Hat Single Sign-on {RH-SSO_VERSION} Client Adapter for JBoss EAP 7* (`rh-sso-{RH-SSO_VERSION}-eap7-adapter.zip`).
. Unzip and install `rh-sso-{RH-SSO_VERSION}-eap7-adapter.zip`. For installation instructions, see the "JBoss EAP Adapter" section of the https://access.redhat.com/documentation/en-us/red_hat_single_sign-on/7.3/html-single/securing_applications_and_services_guide/#jboss_adapter[_Red Hat Single Sign On Securing Applications and Services Guide_].
+
...
. Add the `<system-properties>` subsystem following subsystem:
+
--

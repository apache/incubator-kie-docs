...
. Download *Red Hat Single Sign-on {RH-SSO_VERSION} Client Adapter for EAP 7* (`rh-sso-{RH-SSO_VERSION_LONG}-eap7-adapter.zip` or the latest version).
...
--
+
For more information about management CLI of {EAP}, see the https://access.redhat.com/documentation/en-us/red_hat_jboss_enterprise_application_platform/{EAP_VERSION}/html-single/management_cli_guide/index[_Management CLI Guide_] for {EAP}.

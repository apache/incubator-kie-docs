...
* Entando App Builder 5.0.3 is installed. For instructions, see link:https://central.entando.com/en/documentation.page[_Getting Started with Entando App Builder_].
* You are logged in to the Entando Admin Console.

.Procedure
. In the Entando Admin Console, go to *Integrations* -> *Red Hat PAM Config* -> *Add Configuration*.

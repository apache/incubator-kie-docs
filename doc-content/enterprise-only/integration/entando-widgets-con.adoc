...
For more information about using Entando App Builder widgets, see link:https://central.entando.com/en/documentation.page[_Getting Started with Entando App Builder_].

...
[source]
----
java -Dizpack.mode=privileged -jar {PRODUCT_INIT}-{PRODUCT_VERSION}-UPD.jar
----
...
[source]
----
java -XX:MaxHeapSize=4g -jar {PRODUCT_INIT}-{PRODUCT_VERSION}-UPD.jar
----
====
+
...
[source]
----
java -jar {PRODUCT_INIT}-{PRODUCT_VERSION}-UPD.jar <path-to-file>
----

...
[source]
----
java -jar {PRODUCT_INIT}-{PRODUCT_VERSION}-INS.jar
----
+
[NOTE]
====
...
[source]
----
java -Dizpack.mode=privileged -jar {PRODUCT_INIT}-{PRODUCT_VERSION}-INS.jar
----
...
[source]
----
java -XX:MaxHeapSize=4g -jar {PRODUCT_INIT}-{PRODUCT_VERSION}-INS.jar
----
====
+
...
[source]
----
java -jar {PRODUCT_INIT}-{PRODUCT_VERSION}-INS.jar <path-to-file>
----

...
... Navigate to the https://www.ibm.com/support/pages/node/6596913[IBM Support] page and follow the instruction to download *{PRODUCT} {PRODUCT_VERSION_LONG} Maven Repository* and extract the ZIP file.

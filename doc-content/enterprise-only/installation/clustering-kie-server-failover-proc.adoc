...
... Navigate to the https://www.ibm.com/support/pages/node/6596913[IBM Business Automation Manager Open Editions Download Document]  and follow the instruction to download *{PRODUCT} {PRODUCT_VERSION} - Maven Repository* and extract the ZIP file.

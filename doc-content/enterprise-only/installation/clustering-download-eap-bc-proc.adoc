...
Complete the steps in this section to download and install {EAP} 7.2 and download and repackage {PRODUCT} {PRODUCT_VERSION} for installation in a clustered environment.

.Procedure
. Install {EAP} 7.2 on each node of the cluster:
.. Navigate to the https://access.redhat.com/jbossnetwork/restricted/listSoftware.html[Software Downloads] page in the Red Hat Customer Portal (login required), and select the product and version from the drop-down options:
* *Product: Enterprise Application Platform*
* *Version: {PRODUCT_VERSION}*
.. Click *Download* next to *Red Hat JBoss Enterprise Application Platform 7.2.0*. (`JBEAP-7.2.0/jboss-eap-7.1.0.zip`).

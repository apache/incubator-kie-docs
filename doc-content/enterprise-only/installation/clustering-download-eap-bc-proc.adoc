...
. Navigate to the https://www.ibm.com/support/pages/node/6596913[IBM Business Automation Manager Open Editions Download Document]  and following the instructions to download *{PRODUCT} {PRODUCT_VERSION} - {CENTRAL} for EAP 7* on each node of the cluster.

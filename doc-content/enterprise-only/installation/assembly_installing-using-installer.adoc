...
This section describes how to install {CENTRAL} and {KIE_SERVER} using the installer JAR file. The JAR file is an executable file that installs {PRODUCT} in an existing

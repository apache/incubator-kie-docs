...
[NOTE]
====
You must have a support JDK installed to run the installer. See https://access.redhat.com/articles/3405381[Red Hat Process Automation Manager 7 Supported Configurations] for a list of supported JDKs.

...
You should configure the {CENTRAL} cluster in domain mode with Elasticsearch and Artemis JMS broker resource adapter integrated with {EAP}. By using domain mode with a cluster, you can centrally manage and publish configurations for your servers.

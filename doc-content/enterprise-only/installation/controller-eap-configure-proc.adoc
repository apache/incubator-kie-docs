[id='controller-eap-configure-proc_{context}']
...
* {KIE_SERVER} is installed in the base directory of the {EAP} installation (`__EAP_HOME__`) as described in <<assembly_installing-on-eap-deployable_install-on-eap>> section.
endif::[]

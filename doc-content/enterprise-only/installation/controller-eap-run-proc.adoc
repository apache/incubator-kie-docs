...
. If you installed the {HEADLESS_CONTROLLER} on a separate {EAP} instance from the {EAP} instance where you installed the {KIE_SERVER}, start the {HEADLESS_CONTROLLER} with the `standalone.sh` script:
+
[NOTE]
====

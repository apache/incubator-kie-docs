...
ifdef::DM[]
. Next to *Follow*, select *Products* from the drop-down menu, and then select *{PRODUCT_PAM}* or *Red Hat Decision Manager* from the next drop-down menu that appears.
endif::[]

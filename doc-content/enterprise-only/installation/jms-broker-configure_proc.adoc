...
For information about advanced installations and configuration options, see  https://access.redhat.com/documentation/en-us/red_hat_amq/{AMQ_BROKER_VERSION}/html-single/getting_started_with_amq_broker[_Getting started with AMQ Broker_].

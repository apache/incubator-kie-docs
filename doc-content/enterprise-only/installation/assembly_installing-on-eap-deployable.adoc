...
You can use the Red Hat Process Automation Manager ZIP files (one for {CENTRAL} and one for {KIE_SERVER}) to install Red Hat Process Automation Manager without using the installer.

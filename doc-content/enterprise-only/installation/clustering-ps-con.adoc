...
To create a {KIE_SERVER} clustered runtime environment, you download and extract {EAP} 7.1 and {KIE_SERVER}. Then, you configure {EAP} 7.1 for a cluster, start the cluster, and install {KIE_SERVER} on each cluster node.

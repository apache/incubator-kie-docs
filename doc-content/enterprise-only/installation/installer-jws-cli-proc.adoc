...
.Prerequisite
* A backed-up Red Hat {JWS} {JWS_VERSION_LONG} or higher server installation is available.
...
----
+
. Enter the parent directory of an existing Red Hat {JWS} {JWS_VERSION_LONG} or higher installation.
+

...
* The *{PRODUCT} {PRODUCT_VERSION_LONG} Add Ons* (`{PRODUCT_INIT}-{PRODUCT_VERSION}-AO.zip`) file is downloaded from the https://www.ibm.com/support/pages/node/6596913[IBM Support] page.

...
. To create containers directly against the `kie-server`, enter a command similar to the following command:
//I don't like 'directly against'. What does this mean? Are there any placeholders in this example?
+
----

...
. To create a new container in a managed {KIE_SERVER} so that you can fill it with example data, send the following HTTP request:
+
[source]
----
...
----
+
. Open the `create-container.xml` file in a text editor
+
[source]
----
<script>

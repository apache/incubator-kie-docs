...
. Download and extract the *Red Hat JBoss Data Grid 7.3.0 Server* (`jboss-datagrid-7.3.0-1-server.zip`) installation file to the preferred location on your system.
+
The extracted directory is referred to as `__JDG_HOME__`.

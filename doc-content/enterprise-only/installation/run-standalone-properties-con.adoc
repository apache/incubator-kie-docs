...
* `org.uberfire.nio.git.http.host`: If the HTTP daemon is enabled, it uses this property as local host identifier. This is an informative property, as the HTTP will rely on servlet container, however this is used to display how to get access the git over HTTP. Default: `localhost`
...
* `org.uberfire.nio.git.https.host`: If the HTTPS daemon is enabled, it uses this property as local host identifier. This is an informative property, as the HTTPS will rely on servlet container, however this is used to display how to get access the git over HTTPS. Default: `localhost`

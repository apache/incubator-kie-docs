...
[NOTE]
====
This flag should be used only by {CENTRAL}. If, for any reason, you share runtime environment with any other component, make sure to isolate the configuration and make sure that it's applied only to {CENTRAL}.
====

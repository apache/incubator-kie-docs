...
.Procedure
. Navigate to the https://www.ibm.com/support/pages/node/6596913[IBM Support] page and follow the instructions to download the *{PRODUCT} [VERSION] Update Tool*.
+
...
////
. Click *Patches*, download the *{PRODUCT} [VERSION] Update Tool*,
////

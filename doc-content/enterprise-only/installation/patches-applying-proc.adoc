...
ifdef::DM[]
NOTE: Starting with release 7.13, the distribution files for Red Hat Decision Manager are replaced with Red Hat Process Automation Manager files.
endif::[]

...
$ mv /tmp/rhbaMavenRepoUpdate/rhba-{PRODUCT_VERSION}.1.GA-maven-repository/maven-repository/ $REPO_PATH/{PRODUCT_INIT}-{PRODUCT_VERSION}.0.GA-maven-repository/maven-repository/
----
--
+

...
You can use the same automated update tool to apply both patch updates and minor release upgrades to {PRODUCT_PAM} {PRODUCT_VERSION}. Patch updates of {PRODUCT_PAM}, such as an update from version {PRODUCT_VERSION} to {PRODUCT_VERSION}.1, include the latest security updates and bug fixes. Minor release upgrades of {PRODUCT_PAM}, such as an upgrade from version 7.10.x to 7.11, include enhancements, security updates, and bug fixes.
...
+
If you are upgrading to a new minor release of {PRODUCT_PAM}, such as an upgrade from version 7.10.x to 7.11, first apply the latest patch update to your current version of {PRODUCT_PAM} and then follow this procedure again to upgrade to the new minor release.

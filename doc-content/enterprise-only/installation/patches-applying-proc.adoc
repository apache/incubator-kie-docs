...
You can update or upgrade {PRODUCT} versions 7.2.x through 7.3.1 directly. For example, you can use the 7.3.0 upgrade tool to upgrade {PRODUCT} 7.2.x to version 7.3.0. Likewise, you can directly upgrade {PRODUCT} 7.2.0 to version 7.3.1.

...
You can create a Process Automation Manager, Decision Manager, or {PLANNER} business application using maven archetype commands in Create your business application. After you create and configure your business application, you can deploy it to an existing service or to the cloud, through OpenShift.

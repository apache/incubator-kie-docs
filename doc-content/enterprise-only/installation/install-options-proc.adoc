...
* Download and run the executable JAR installer for installation on {EAP} {EAP_VERSION} or Red Hat JBoss Web Server 5.0. The installer graphical user interface guides you through the installation process.

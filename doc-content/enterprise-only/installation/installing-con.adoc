...
* Business Central is the graphical user interface where you create and manage business rules.
+
...
* KIE Server is the server where rules and other artifacts are executed. It is used to instantiate and execute rules and solve planning problems.

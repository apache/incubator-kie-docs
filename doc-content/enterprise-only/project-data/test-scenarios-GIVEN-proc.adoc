...
image::enterpriseImages/project-data/test-scenario-facts.png[Add GIVEN input to the test scenario]
+
...
+
.Modify a fact field
image::enterpriseImages/project-data/test-scenario-field.png[Modifying a condition]
+

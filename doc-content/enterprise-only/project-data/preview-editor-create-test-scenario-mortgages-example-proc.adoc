...
In this chapter, as an example for better understanding, you will create and execute a test scenario from the sample *Mortgages* project shipped with {CENTRAL} using the *Test Scenario (Preview)* editor.
...
+
.The Test Scenario (Preview) editor

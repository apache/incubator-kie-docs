...
image::enterpriseImages/project-data/test-scenario-expected-rules.png[Add EXPECT results to the test scenario]
+
...
+
.Modify a fact field
image::enterpriseImages/project-data/test-scenario-field-value.png[Modify a fact field]
+

...
*Test Scenario (Preview)* editor will load all data objects that are located in the same package as the test scenario. You can view all the data objects from the *Data Objects* tab in the editor. The loaded data objects are also displayed in the *Test Editor* tab in the *Test Tools* panel.

...
* Avoid contacting external services through a Script Task. It would be interacting with external services without notifying the {PROCESS_ENGINE}, which can be problematic. Model communication with an external service using a Service Task.

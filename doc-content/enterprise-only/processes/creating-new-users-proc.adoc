...
image::enterpriseImages/Designer/select-group.png[Selecting group assignments for Katy]

. Click the *Roles* tab and click *Add roles*.
+
.Add roles for *Katy*
image::enterpriseImages/Designer/add-roles.png[Add roles menu location]
...
+
.Add roles for *Bill*
image::enterpriseImages/Designer/roles.png[Add roles menu location]

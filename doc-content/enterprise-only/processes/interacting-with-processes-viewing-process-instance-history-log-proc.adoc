[id='interacting-with-processes-viewing-process-instance-history-log-proc']
...
. On the *Process Instances* page, click on the process instance whose log you want to view.

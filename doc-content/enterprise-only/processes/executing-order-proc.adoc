...
image::enterpriseImages/processes/start-instance.png[Inputting the order information in to the order form]
...
image::enterpriseImages/processes/manage-instance.png[Viewing the process details in the Manage Process Instances view]
...
image::enterpriseImages/processes/diagram-flow.png[Viewing the process flow in the process diagram]
...
image::enterpriseImages/processes/orderprice.png[Employee adds the order total to be returned to the customer]

...
image::enterpriseImages/processes/ProcessInstancesSearchSmall.png[Filtering Process Instances - Default View]
...
image::enterpriseImages/processes/DateRangeSearch.png[Search by Date Range]

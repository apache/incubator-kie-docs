...
image::enterpriseImages/processes/create-end-order.png[Creating an outgoing connection from the Confirmation user task]

. Convert the new task to a user task.

+
.Connect to an end event
image::enterpriseImages/processes/pizza-proc.png[Connecting to an end event]

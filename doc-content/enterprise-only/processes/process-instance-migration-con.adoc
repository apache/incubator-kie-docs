...
For more information about the PIM service, see https://github.com/kiegroup/process-migration-service/tree/7.67.x-blue[Process Instance Migration Service] in https://github.com/kiegroup[_KIE (Drools and jBPM )_].

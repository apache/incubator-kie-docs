...
. Download the sample source of the router extention from the https://github.com/jboss-container-images/rhpam-7-openshift-image/tree/{ENTERPRISE_VERSION_LONG}.GA/quickstarts/router-ext[GitHub repository].
...
[subs="attributes,verbatim,macros,quotes"]
----
FROM registry.redhat.io/ibm-bamoe/bamoe-smartrouter-rhel8:{ENTERPRISE_VERSION_LONG}

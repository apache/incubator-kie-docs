...
+
If you also want to enable the same automatic upgrade process when a new minor version of {PRODUCT} 8.x becomes available, select the *Include minor version upgrades* box.
+
[NOTE]
====

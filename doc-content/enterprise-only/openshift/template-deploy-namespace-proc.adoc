...
If you installed an image streams file according to instructions in <<imagestreams-file-install-proc>>, set the *ImageStream Namespace* (`IMAGE_STREAM_NAMESPACE`) parameter to the name of your OpenShift project.

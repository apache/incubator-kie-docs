[id='apb-deprovision-proc_{context}']
= Deprovisioning an {PRODUCT} environment using the Automation Broker

If you deployed an {PRODUCT} environment using the Automation Broker, you can also use the Broker to deprovision the environment.

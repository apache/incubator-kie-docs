...
.  DNavigate to the https://www.ibm.com/support/pages/node/6596913[IBM Business Automation Manager Open Editions Download Document]  and follow the instructions to download the `{PRODUCT_INIT_TOP}-{PRODUCT_VERSION}-RI.Zip` product deliverable file.

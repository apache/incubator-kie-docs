...
.  DNavigate to the {PRODUCT_DOWNLOAD_LINK}[IBM Business Automation Manager Open Editions {ENTERPRISE_VERSION} downloads] page  and follow the instructions to download the `{PRODUCT_INIT_TOP}-{PRODUCT_VERSION}-RI.Zip` product deliverable file.

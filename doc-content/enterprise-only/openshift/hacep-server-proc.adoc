...
----
+
. Use the OpenShift operator infrastructure to install Red Hat AMQ Streams on a node that has at least 16 gigabytes of memory. For information about installing Red Hat AMQ Streams, see https://access.redhat.com/documentation/en-us/red_hat_amq/7.3/html/using_amq_streams_on_openshift_container_platform/index[_Using AMQ Streams on OpenShift Container Platform_].

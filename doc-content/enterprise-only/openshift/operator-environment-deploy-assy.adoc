...
After you subscribe to {operator_name}, you can use the installer wizard to configure and deploy an {PRODUCT} environment.

[IMPORTANT]
====
In {PRODUCT} {PRODUCT_VERSION}, the operator installer wizard is for Technology Preview only. 
====

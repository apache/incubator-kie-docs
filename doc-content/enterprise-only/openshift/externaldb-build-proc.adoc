...
** CEKit version 3.8.0: For installation instructions, see https://docs.cekit.io/en/3.8.0/handbook/installation/index.html[Installation].
** The following libraries and extensions for CEKit. For more information, see https://docs.cekit.io/en/3.8.0/handbook/installation/dependencies.html[Dependencies].

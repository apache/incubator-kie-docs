...
** {CEKIT} version {CEKIT_VERSION_LONG}: For installation instructions, see https://docs.cekit.io/en/{CEKIT_VERSION_LONG}/handbook/installation/index.html[Installation].

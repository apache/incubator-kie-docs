...
.. Download the `{PRODUCT_FILE}-OTP.zip` product deliverable file from the {PRODUCT_DOWNLOAD_LINK}[IBM Support] page and extract the `{PRODUCT_INIT}{ENTERPRISE_VERSION_SHORT}-image-streams.yaml` file.

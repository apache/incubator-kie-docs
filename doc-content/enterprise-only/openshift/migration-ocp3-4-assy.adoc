...
If you previously used an {PRODUCT} deployment on {OPENSHIFT} {OPENSHIFT_VERSION_SHORT_OLD}, you can migrate the information from that deployment to a new deployment on {OPENSHIFT} {OPENSHIFT_VERSION_SHORT}.

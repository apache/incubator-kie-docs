...
.. Change directory to the `TEMP_DIR/{PRODUCT_INIT}-{PRODUCT_VERSION}.x-migration-tool/ddl-scripts` directory. This directory contains DDL scripts for several database types.

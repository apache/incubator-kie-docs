...
. Click *Install*.
. Navigate to the temporary directory where you downloaded and extracted the `{PRODUCT_INIT_TOP}-{PRODUCT_VERSION}-KS7.Zip` file, and go to `{PRODUCT_FILE}-kie-server-ee7/kie-server.war`.

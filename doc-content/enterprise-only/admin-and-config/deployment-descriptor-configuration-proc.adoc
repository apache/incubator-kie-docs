...
WARNING: Do not use the Singleton runtime strategy with the EJB Timer Scheduler (the default scheduler in {KIE_SERVER}) in a production environment. This combination can result in Hibernate problems under load.

...
The {KIE_SERVER} allows you to create and provision multiple KIE containers (deployment units). Use the following procedure to create and interact with multiple containers:

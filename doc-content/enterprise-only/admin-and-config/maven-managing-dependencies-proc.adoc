...
. For standalone projects that are not authored in {CENTRAL}, specify all dependencies required for your projects. In projects that you author in {CENTRAL}, the basic {ENGINE} dependencies are provided automatically by {CENTRAL}.
+
...
.CDI-enabled {ENGINE} dependencies
[source,xml]
----
<dependency>
  <groupId>org.kie</groupId>

...
image::enterpriseImages/admin-and-config/assets-renaming.png[Copy, rename, delete, or archive assets]

You can also use the following toolbar buttons to copy, rename, or delete assets.

.Toolbar options
image::enterpriseImages/admin-and-config/tools.png[Copy, rename, or delete assets]

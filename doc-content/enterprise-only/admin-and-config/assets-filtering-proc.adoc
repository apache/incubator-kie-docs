...
+
.Creating tags
image::enterpriseImages/admin-and-config/Creating_Tags.png[Creating Tags in Matadata view]
+
The assigned tags are displayed as buttons next to the *Tags* field.
+
.Tags in metadata view
image::enterpriseImages/admin-and-config/Created_Tags.png[Tags created in Metadata View]
+
To delete a tag, click the tag button with the trash icon.
+
.Deleting tags in metadata view
image::enterpriseImages/admin-and-config/delete-tag.png[Deleting tags in Metadata View]
...
image::enterpriseImages/admin-and-config/Enable_Tag_Filtering.png[Enable Tag Filtering in Customize View]
...
.Filter by tag
image::enterpriseImages/admin-and-config/Filter_By_Tag.png[Enable Tag Filtering in Customize View]

...
----
--
. Run the configured `.java` class from your project directory. You can run the file in your development platform (such as Red Hat CodeReady Studio) or in the command line.
+
--

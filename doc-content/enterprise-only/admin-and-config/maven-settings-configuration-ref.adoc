...
.Procedure
. In the `settings.xml` file, declare the Maven repository that you download from the https://www.ibm.com/docs/ibamoe[IBM Business Automation Manager Open Editions 8.0 downloads] page and any repositories for custom artifacts that you want to use.

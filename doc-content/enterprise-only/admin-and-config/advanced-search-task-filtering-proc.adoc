...
image::enterpriseImages/admin-and-config/TaskAdminSearchSmall.png[Filtering Tasks - Default View]
...
+
.Search by Date
image::enterpriseImages/admin-and-config/DateRangeSearch.png[Search by Date Range]

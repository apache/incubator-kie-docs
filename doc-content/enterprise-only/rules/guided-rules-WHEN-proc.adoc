...
image::enterpriseImages/rules/5687.png[Add a condition to the rule]
+
...
+
.Modify a condition
image::enterpriseImages/rules/5689.png[Modifying a condition]
+
[NOTE]
====
...
image::enterpriseImages/rules/5688.png[Modifying a condition]
+

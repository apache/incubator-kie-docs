...
image::enterpriseImages/rules/guided-rule-templates-data-table.png[Sample data table for a guided rule template]
+
...
image::enterpriseImages/rules/guided-rule-templates-cell-merging.png[Merge cells in a data table]
+
...
image::enterpriseImages/rules/guided-rule-templates-cell-merging-02.png[Collapse merged cells]
+

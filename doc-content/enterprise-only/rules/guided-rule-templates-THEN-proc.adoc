...
image::enterpriseImages/rules/guided-rule-templates-add-action.png[Add a new action to the rule]
+
...
+
.Add a field
image::enterpriseImages/rules/guided-rule-templates-add-field.png[Add a field]
+

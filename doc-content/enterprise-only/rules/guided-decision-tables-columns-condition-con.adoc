...
* *Entry point:* Define the entry point for the fact pattern, if applicable. An entry point is a gate or stream through which facts enter the {PRODUCT} {ENGINE}, if specified. (Examples: `Application Stream`, `Credit Check Stream`)

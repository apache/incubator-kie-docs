...
image::enterpriseImages/rules/guided-rule-templates-add-condition.png[Add a condition to the rule]
+
...
+
.Modify a condition
image::enterpriseImages/rules/guided-rule-templates-modify-condition.png[Modifying a condition]
+
[NOTE]
====
...
image::enterpriseImages/rules/guided-rule-templates-multiple-constraints.png[Add multiple field constraints]

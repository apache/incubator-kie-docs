...
+
.Add Rows
image::enterpriseImages/rules/guided-decision-tables-rows-add.png[Add rows in the guided decision tables designer]
+
...
image::enterpriseImages/rules/guided-decision-tables-rows-add_02.png[Enter data in individual cells]
+

...
{PLANNER} integrates with the guided rules designer and provides score modifiers, which are used by the {PLANNER} engine during the solving process.
...
image::enterpriseImages/optimizer/guided-rule-editor-rhs.png[align="center"]

...
image::enterpriseImages/UseCasesAndExamples/ExamTimetabling/examinationTimetablingUseCase.png[align="center"]
...
== Domain model for Exam timetabling
The following diagram shows the main examination domain classes:

.Examination domain class diagram
image::enterpriseImages/UseCasesAndExamples/ExamTimetabling/examinationDomainDiagram.png[align="center"]

...
image::enterpriseImages/UseCasesAndExamples/MachineReassignment/cloudOptimizationIsLikeTetris.png[align="center"]
...
.Domain model
image::enterpriseImages/UseCasesAndExamples/MachineReassignment/machineReassignmentClassDiagram.png[align="center"]
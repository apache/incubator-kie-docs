...
.Value proposition
image::enterpriseImages/UseCasesAndExamples/TaskAssigning/taskAssigningValueProposition.png[align="center"]
...
.Domain model
image::enterpriseImages/UseCasesAndExamples/TaskAssigning/taskAssigningClassDiagram.png[align="center"]

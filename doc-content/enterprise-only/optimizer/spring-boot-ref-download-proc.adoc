...
. Download the *Red Hat Process Automation Manager {PRODUCT_VERSION_LONG} Kogito and OptaPlanner 8 Decision Services Maven Repositroy* (`{PRODUCT_INIT}-{PRODUCT_VERSION_LONG}-kogito-maven-repository.zip`).

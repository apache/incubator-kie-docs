...
The vehicle routing with time windows domain model makes heavy use of the shadow variable feature.
...
For example, GraphHopper will by default return the fastest route, not the shortest route.

...
By default, the {PLANNER} engine is given an unlimited time period to solve a problem instance.
...
image::enterpriseImages/optimizer/termination_editor.png[align="center"]

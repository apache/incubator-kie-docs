...
Otherwise, the property is taken from the `application.properties` file and defaults to `kogito-1.5.0-decision-services-quickstarts/optaweb-8.5.0.Final-redhat-00001/{URL_COMPONENT_VRP}/optaweb-vehicle-routing-standalone/target/local/dataset`.

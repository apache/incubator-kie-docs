...
This will make the application use configurations in the `application-local.properties` file.
...
This will enable you to use the *Update* action to quickly restart the application.
+

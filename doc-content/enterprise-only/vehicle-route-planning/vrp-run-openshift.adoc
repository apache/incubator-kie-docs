...
[source]
----
./runOnOpenShift.sh belgium-latest.osm.pbf BE
----
COMMENT: This example doesn't seem to match the template (./runOnOpenShift.sh <OSM_FILE_NAME> <COUNTRY_CODE_LIST> <OSM_FILE_DOWNLOAD_URL>)

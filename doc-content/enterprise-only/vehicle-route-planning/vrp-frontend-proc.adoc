...
Whenever the dependencies listed in `package.json` change, for example when you pull changes to the main branch, you must execute `npm install` before you run the development server.

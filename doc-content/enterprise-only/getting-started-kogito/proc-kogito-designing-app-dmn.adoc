...
In VS Code, you can add the *IBM Business Automation Bundle* VS Code extension to design the decision requirements diagram (DRD), boxed expression, and data types with the DMN modeler.

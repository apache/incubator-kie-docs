...
+
image::enterpriseImages/getting-started/applicant_do.png[]

. Review the *Applicant* data object fields.
+
image::enterpriseImages/getting-started/field-data-applicant.png[]
...
+
image::enterpriseImages/getting-started/application_do.png[]

. Review the *Application* data object fields.
+
image::enterpriseImages/getting-started/field-data-application.png[]
...
+
image::enterpriseImages/getting-started/property_do.png[]
. Review the *Property* data object fields.
+
image::enterpriseImages/getting-started/field-data-property.png[]
...
+
image::enterpriseImages/getting-started/val-error.png[]

. Review the *Property* data object fields.
+
image::enterpriseImages/getting-started/field-data-val-error.png[]

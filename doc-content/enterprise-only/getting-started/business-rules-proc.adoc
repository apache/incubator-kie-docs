...
//+
//image::enterpriseImages/getting-started/condition.png[]
...
+
image::enterpriseImages/getting-started/equal-to.png[]

. Click image:getting-started/6191.png[], select *Literal value*, and enter `0`.
+
image::enterpriseImages/getting-started/literal-val.png[]
...
+
image::enterpriseImages/getting-started/error-field.png[]
...
+
image::enterpriseImages/getting-started/then-values.png[]
...
+
image::enterpriseImages/getting-started/then-values2.png[]

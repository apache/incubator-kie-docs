...
NOTE: If you have not created a project, you can either add a project, use a sample project, or import an existing project. For more information, see {URL_MANAGING_PROJECTS}[_{MANAGING_PROJECTS}_].

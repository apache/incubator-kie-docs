...
.. Click *Save*.
. In the diagram editor, to save the changes made to the business process, click *Save* to confirm your changes.
...
. Click *Save*. Above the canvas, click *Save* to confirm your changes.

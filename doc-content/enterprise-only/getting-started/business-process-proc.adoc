...
+
image::enterpriseImages/getting-started/exclusive-gateway.png[]

. Create an outgoing connection from the exclusive gateway to a task.
+
image::enterpriseImages/getting-started/create-task.png[]

. Convert the new task to a business rule task.
+
image::enterpriseImages/getting-started/bus-rule-task.png[]
...
+
image::enterpriseImages/getting-started/val-data-io.png[]
...
+
image::enterpriseImages/getting-started/exclusive_gateway.png[]

. Create an outgoing connection from the exclusive gateway to a new business rule task.
+
image::enterpriseImages/getting-started/new_br_task.png[]

. Click the created connection.
+
image::enterpriseImages/getting-started/created-connection.png[]
...
+
image::enterpriseImages/getting-started/user_task.png[]
...
+
image::enterpriseImages/getting-started/second-gateway.png[]
...
+
image::enterpriseImages/getting-started/mortgage-calc-assignments.png[]
...
+
image::enterpriseImages/getting-started/new-proc-var.png[]
...
+
image::enterpriseImages/getting-started/qualify-task.png[]
...
+
image::enterpriseImages/getting-started/qualify-io.png[]
...
----
+
image::enterpriseImages/getting-started/inlimit-true.png[]
...
+
image::enterpriseImages/getting-started/approval-io.png[]
...
+
image::enterpriseImages/getting-started/create_end.png[]
+
image::enterpriseImages/getting-started/end-event.png[]
...
+
image::enterpriseImages/getting-started/new-task.png[]
...
----
+
image::enterpriseImages/getting-started/not-inlimit.png[]
...
* *Data Type*: `Boolean`
+
image::enterpriseImages/getting-started/proc-var-new.png[]
...
+
image::enterpriseImages/getting-started/increase-down-io.png[]
...
+
image::enterpriseImages/getting-started/connection_icon2.png[]
...
image::enterpriseImages/getting-started/finalBP.png[]

...
.Custom data object in multiple variables causes an error in a case project [https://issues.redhat.com/browse/RHPAM-4422[RHPAM-4422]]
...
.Optaplanner dependencies were not removed from features files [https://issues.redhat.com/browse/RHPAM-4545[RHPAM-4545]]

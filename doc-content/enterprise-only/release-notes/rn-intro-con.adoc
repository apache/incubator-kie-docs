...
For information about the support policy for {PRODUCT}, see the https://www.ibm.com/support/pages/node/6596913[IBM Business Automation Manager Open Editions Download Document] .

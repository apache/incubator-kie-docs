...
For information about the support policy for {PRODUCT}, see the https://access.redhat.com/articles/3639591[_Release maintenance plan for Red Hat Decision Manager 7.x and {PRODUCT_PAM} 7.x_].

...
* When you migrate to Red Hat Process Automation Manager version 7.12.0 from a previous version, {Central} fails to start with the *no marshaller for type: org.guvnor.structure.contributors.Contributor* error [https://issues.redhat.com/browse/RHPAM-4152[RHPAM-4152]]

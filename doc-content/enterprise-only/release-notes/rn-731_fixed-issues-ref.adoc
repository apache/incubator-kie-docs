...
* Column sorting is not retained after filters are applied in the Task in box [https://issues.jboss.org/browse/RHPAM-1700[RHPAM-1700]]
...
* XStream marshaller does not work with PMML on execution server [https://issues.jboss.org/browse/RHDM-1900[RHDM-1900]]

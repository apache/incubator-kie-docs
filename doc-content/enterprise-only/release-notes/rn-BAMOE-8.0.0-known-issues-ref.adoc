[id='rn-BAMOE-8.0.0-known-issues-ref_{context}']
...
Issue: Kafka dependencies for the community are not aligned with {PRODUCT} {PRODUCT_VERSION}. The current version of the Kafka community version is 2.8.0 and it must be aligned with the version used by {AMQ_STREAMS} 2.1.0 which is 3.1.0 for the community.

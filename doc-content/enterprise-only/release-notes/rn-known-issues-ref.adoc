...
Issue: If you install {KIE_SERVER} on {JWS} either by using the installer or by manual installation, when you run {KIE_SERVER} several  SEVERE exceptions appear in the `localhost.log` file.

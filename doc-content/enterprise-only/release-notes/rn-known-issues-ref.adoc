...
.The multiple instance properties of a multiple instance sub-process are not visible for nodes inside of a multiple instance sub-process [https://issues.jboss.org/browse/RHPAM-2257[RHPAM-2257]]

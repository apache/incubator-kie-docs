...
* When you set a `BigDecimal` variable to a `String` literal value in an executable model, you receive a compilation error [https://issues.redhat.com/browse/RHDM-1715[RHDM-1715]]

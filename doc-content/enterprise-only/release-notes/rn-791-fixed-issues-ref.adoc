...
* You can use the newly added reference implementation to create a school timetable using {PLANNER} with Spring Boot. See {URL_DEVELOPING_SOLVERS}#assembly-business-optimizer-springboot[_{PLANNER_WITH_SPRING_BOOT}_] for instructions. [https://issues.redhat.com/browse/RHDM-1430[RHDM-1430]]

...
ifdef::PAM[]
For a complete list of supported configurations, see https://www.ibm.com/support/pages/node/6596919[IBM Business Automation Manager Open Editions 8 Supported Configurations].
endif::PAM[]

...
=== Automatic major and minor patch updates in operator deployments on {OPENSHIFT}

When you deploy {PRODUCT} on {OPENSHIFT} using the Business Automation operator, you can now enable automatic major and minor patch updates.

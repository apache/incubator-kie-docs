...
=== Queries with extra parameters
If you call a query and include more parameters than you included in the query definition, for example if the query has two parameters and you call it with three parameters, a runtime exception is thrown with a message indicating the number of expected parameters.

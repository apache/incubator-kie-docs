...
* Remove the duplicated KIE_SERVER_BYPASS_AUTH_USER required parameter from KIE server configuration [https://issues.jboss.org/browse/RHPAM-1152[RHPAM-1152]]

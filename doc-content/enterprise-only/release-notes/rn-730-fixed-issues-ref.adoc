...
* Plans are not provisioned by the OpenShift APB image [https://issues.jboss.org/browse/RHPAM-1628[RHPAM-1628]]
...
* APB issues occur with a managed environment [https://issues.jboss.org/browse/RHPAM-1778[RHPAM-1778]]
...
* In a guided rule template, if you perform a sort operation on any column and then save changes, some values are missed or changed  [https://issues.jboss.org/browse/RHDM-827[RHDM-827]]

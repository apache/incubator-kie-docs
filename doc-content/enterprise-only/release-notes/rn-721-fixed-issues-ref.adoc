...
== Process designer
* Cannot set a sub-process from different project as reusable [https://issues.jboss.org/browse/RHPAM-1667[RHPAM-1667]]
* Cannot attach boundary events to service tasks in the new process designer [https://issues.jboss.org/browse/RHPAM-1773[RHPAM-1773]]

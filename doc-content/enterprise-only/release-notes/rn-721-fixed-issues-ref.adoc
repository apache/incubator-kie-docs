...
ifdef::DM[]
* Incremental compilation fails when calling a static method in RHS [https://issues.jboss.org/browse/RHDM-709[RHDM-709]]
endif::DM[]
ifdef::PAM[]
* Incremental compilation fails when calling a static method in RHS [https://issues.jboss.org/browse/RHPAM-1453[RHPAM-1453]]
endif::PAM[]
...
* The RESTeasy version in the Maven repository does not match the version in the binaries [https://issues.jboss.org/browse/RHPAM-1845[RHPAM-1845]]

== Process designer

* Cannot set a sub-process process from a different project as reusable [https://issues.jboss.org/browse/RHPAM-1667[RHPAM-1667]]

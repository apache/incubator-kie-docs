...
The *Assets* view of the project opens. Select each example asset to explore how the project is designed to achieve the specified goal or workflow. You can refer back to the *IT_Orders* sample project assets as needed when you create your own case project.

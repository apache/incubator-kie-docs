...
. Expand *Data Assignments*, click image:getting-started/diagram_properties.png[] in the *Assignments* field, and add the following new condition in the *Milestone 1: Order placed Data I/O* window.
...
. Expand *Implementation/Execution*, click the down arrow in the *Signal* field, and select `Milestone 2: Order shipped`.

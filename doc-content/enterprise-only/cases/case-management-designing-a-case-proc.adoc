...
image::enterpriseImages/cases/itorders-orderhardware-process.png[IT Orders case design]
...
+
.IT Orders variables
image::enterpriseImages/cases/case-variables.png[Editor for IT Orders variables]
+
...
.ITOrders Case Roles
image::enterpriseImages/cases/case_roles.png[Case Roles]
...
+
image::enterpriseImages/cases/milestone-evaluation-condition.png[Milestone evaluation condition configuration]
+

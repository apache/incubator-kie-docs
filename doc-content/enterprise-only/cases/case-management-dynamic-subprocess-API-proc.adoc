...
Use the following procedure to use the Swagger REST API to create a dynamic subprocess task for the *IT_Orders* sample project available in {CENTRAL} . The same endpoint can be used for REST API without Swagger.

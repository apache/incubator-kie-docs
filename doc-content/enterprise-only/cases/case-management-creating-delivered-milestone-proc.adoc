...
. Input `Milestone3DeliveredToCustomer` in the *Name* field.
...
. Click *Save*.
. Click *Milestone3DeliveredToCustomer* and create a new user task.
...
+
.DeliveredToCustomer milestone
image::cases/milestone3.png[DeliveredToCustomer milestone]

*IT_Orders*[id='case-management-dynamic-tasks-during-stages-proc']
...
.Procedure
. Start a new case using the Showcase application. For more information about using Showcase, see {URL_USING_SHOWCASE_APPLICATION}[_{USING_SHOWCASE_APPLICATION}_].
+

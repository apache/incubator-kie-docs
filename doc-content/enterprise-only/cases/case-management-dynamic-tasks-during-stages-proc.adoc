...
image::enterpriseImages/cases/itorders-stages.png[]  
...
+
image::enterpriseImages/cases/case-with-stages-showcase.png[]
+
...
+
image::enterpriseImages/cases/case-with-stage-diagram-view.png[]
+

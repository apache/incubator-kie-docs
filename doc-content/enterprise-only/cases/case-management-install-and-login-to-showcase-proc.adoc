...
. Download *{PRODUCT} 7.3.0 Add Ons*
ifdef::PAM[]
...
file. The
ifdef::PAM[]
(`rhpam-7.3-case-mgmt-showcase-eap7-deployable.zip`).
endif::PAM[]
ifdef::DM[]
(`rhdm-7.3-case-mgmt-showcase-eap7-deployable.zip`).
endif::DM[]
...
ifdef::PAM[]
`_TEMP_DIR/rhpam-7.3-case-mgmt-showcase-eap7-deployable/jboss-eap-7.3`
endif::PAM[]
ifdef::DM[]
`_TEMP_DIR/rhdm-7.3-case-mgmt-showcase-eap7-deployable/jboss-eap-7.3`
endif::DM[]

...
.Prerequisites
* The Maven repository for {PRODUCT} {PRODUCT_VERSION} has been downloaded from the https://www.ibm.com/support/pages/node/6596913[IBM Business Automation Manager Open Editions {ENTERPRISE_VERSION} downloads] page  and made available to the local Maven installation (as a local or remote repository).

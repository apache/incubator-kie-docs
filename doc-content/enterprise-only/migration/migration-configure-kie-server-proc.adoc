...
-Dorg.kie.server.user=username <3>
-Dorg.kie.server.pwd=password <4>
-Dorg.kie.server.controller=http://localhost:8080/{URL_COMPONENT_CENTRAL}/rest/controller <5>
-Dorg.kie.server.controller.user=process_server_username <6>
-Dorg.kie.server.controller.pwd=process_server_password <7>

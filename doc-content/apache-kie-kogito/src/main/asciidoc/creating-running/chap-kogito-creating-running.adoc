...
|Task Notification        | kogito-addons-quarkus-task-notification          |10.0.0
...
|Process Management   |kogito-addons-springboot-process-management     |10.0.0
|Process SVG          |kie-addons-springboot-process-svg               |10.0.0
|Task Management      |jbpm-addons-springboot-task-management          |10.0.0
|Task Notification    |kogito-addons-springboot-task-notification      |10.0.0

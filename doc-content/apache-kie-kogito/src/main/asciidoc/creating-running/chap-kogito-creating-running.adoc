...
. In a command terminal, navigate to the desired example in `incubator-kie-kogito-examples' and enter one of the following commands to build and run the example.
+
--

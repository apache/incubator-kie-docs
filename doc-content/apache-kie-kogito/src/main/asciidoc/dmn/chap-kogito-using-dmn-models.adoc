...
{PRODUCT} provides runtime support for DMN 1.1, 1.2, 1.3, 1.4 and 1.5 models at conformance level 3 and design support for DMN 1.2 (Classic DMN Editor) and 1.5 models (New DMN Editor) at conformance level 3.
...
[id="con-dmn-conditional-expressions_{context}"]
...
image::kogito/dmn/dmn-conditional-expression.png[]

[id="con-dmn-conditional-every-expressions_{context}"]
...
image::kogito/dmn/dmn-conditional-every-expression.png[]

[id="con-dmn-conditional-some-expressions_{context}"]
...
[id="con-dmn-iterator-for-expressions_{context}"]
...
image::kogito/dmn/dmn-iterator-for-expression.png[]

[id="con-dmn-filter-expressions_{context}"]
...
image::kogito/dmn/dmn-filter-expression.png[]
...
+
NOTE: When you finish creating your decision model, you can click *Download* in the *Apache KIE™ Sandbox* page to import your DMN file into your {PRODUCT} project.

. Open the new or imported DMN file to view the decision requirements diagram (DRD) in the {PRODUCT} DMN modeler.
+
--
If the DRD does not open in the {PRODUCT} DMN modeler, ensure that you have installed and enabled the *{VSCODE_EXTENSION}* VSCode extension.
...
NOTE: Included models are not supported in the *{CHROME_EXTENSION} Chrome extension* and *BPMN and DMN Standalone Editors*.
...
<response type="SUCCESS" msg="Ok models successfully retrieved from container 'Traffic-Violation_1.0.0'">
    <dmn-model-info-list>
        <model>
            <model-namespace>https://github.com/apache/incubator-kie-drools/kie-dmn/_60b01f4d-e407-43f7-848e-258723b5fac8</model-namespace>
            ...
            <inputs>
                <dmn-inputdata-info>
                    ...
                    <inputdata-typeref>
                        <namespace-uri>https://github.com/apache/incubator-kie-drools/kie-dmn/_60B01F4D-E407-43F7-848E-258723B5FAC8</namespace-uri>
...
----
{
  ...
  "result" : {
    "dmn-model-info-list" : {
      "models" : [ {
        "model-namespace" : "https://github.com/apache/incubator-kie-drools/kie-dmn/_60B01F4D-E407-43F7-848E-258723B5FAC8",
        ...
        "inputs" : [ {
          ...
          "inputdata-typeRef" : {
            "namespace-uri" : "https://github.com/apache/incubator-kie-drools/kie-dmn/_60B01F4D-E407-43F7-848E-258723B5FAC8",
...
[source]
----
curl -u wbadmin:wbadmin -H "accept: application/json" -H "content-type: application/json" -X POST "http://localhost:8080/kie-server/services/rest/server/containers/traffic-violation_1.0.0/dmn" -d "{ \"model-namespace\" : \"https://github.com/apache/incubator-kie-drools/kie-dmn/_60B01F4D-E407-43F7-848E-258723B5FAC8\", \"model-name\" : \"Traffic Violation\", \"dmn-context\" : {\"Driver\" : {\"Points\" : 15}, \"Violation\" : {\"Type\" : \"speed\", \"Actual Speed\" : 135, \"Speed Limit\" : 100}}}"
----
...
----
{
  ...
  "result": {
      "dmn-evaluation-result": {
          "messages": [],
          "model-namespace": "https://github.com/apache/incubator-kie-drools/kie-dmn/_7D8116DE-ADF5-4560-A116-FE1A2EAFFF48",
          "model-name": "Traffic Violation",
          "decision-name": [],
          "dmn-context": {
              "Violation": {
...
<response type="SUCCESS" msg="OK from container 'Traffic_1.0.0-SNAPSHOT'">
    <dmn-evaluation-result>
        <model-namespace>https://github.com/apache/incubator-kie-drools/kie-dmn/_A4BCA8B8-CF08-433F-93B2-A2598F19ECFF</model-namespace>
        <model-name>Traffic Violation</model-name>
        <dmn-context xsi:type="jaxbListWrapper" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
            <type>MAP</type>
            <element xsi:type="jaxbStringObjectPair" key="Violation">
...
IMPORTANT: This procedure applies only when you are using a locally cloned copy of the https://github.com/apache/incubator-kie-kogito-apps/tree/master/trusty-ui[{PRODUCT} Audit Console] repository in GitHub.

.Prerequisites
* You have cloned the https://github.com/apache/incubator-kie-kogito-apps/tree/master/trusty-ui[{PRODUCT} Audit Console] repository from GitHub.

...
ifdef::DM,PAM[]
* `kie-dmn-jpmml` JAR file in the *{PRODUCT} {PRODUCT_VERSION_LONG} Maven Repository* distribution (`{PRODUCT_FILE}-maven-repository/maven-repository/org/kie/kie-dmn-jpmml/{MAVEN_ARTIFACT_VERSION}/kie-dmn-jpmml-{MAVEN_ARTIFACT_VERSION}.jar`) from the IBM Support page.
endif::[]

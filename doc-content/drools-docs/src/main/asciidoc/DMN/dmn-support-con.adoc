...
* Import DMN files into your project in {CENTRAL} (*Menu -> Design -> Projects -> Import Asset*). Any DMN 1.1 and 1.3 models, non including DMN 1.3 features, that you import into {CENTRAL}, open in the DMN designer, and save are converted to DMN 1.2 models.

...
.Two Phase Execution
image::droolsImages/UserGuide/Two_Phase.png[]
...
image::droolsImages/UserGuide/tables1.png[]
...
image::droolsImages/UserGuide/tables2.png[]
...
.CashFlows and Account
image::droolsImages/UserGuide/tables7.png[]


After all of the above activations are fired, the account has a balance of -25.

.CashFlows and Account
image::droolsImages/UserGuide/tables3.png[]
...
.CashFlows and Account
image::droolsImages/UserGuide/tables4.png[]


.CashFlows and Account
image::droolsImages/UserGuide/tables5.png[]
...
.CashFlows and Account
image::droolsImages/UserGuide/tables6.png[]
...
image::droolsImages/UserGuide/ruleflow.png[]

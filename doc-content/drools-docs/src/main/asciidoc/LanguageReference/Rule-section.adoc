...
For example is not possible to use an external binding in the code while using the MVEL Dialect.
...
Support for inline accumulate will be eventually dropped in the next releases of Drools

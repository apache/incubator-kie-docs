...
The following example is a query in a DRL file for underage applicants in a mortgage application decision service:

.Example query and query results for people under the age of 21
[source]
----
...
.Example iteration over query results
[source]
----
query "people under the age of 21"
    $person : Person( age < 21 )

...
* Red Hat Process Automation Manager is installed and configured with {KIE_SERVER}. For more information see {URL_INSTALLING_AND_CONFIGURING}#assembly-install-on-eap[_{INSTALLING_ON_EAP}_].
//xreflink
...
include::Examples/decision-examples-central-con.adoc[leveloffset=+1]
include::Examples/decision-examples-central-proc.adoc[leveloffset=+2]

include::DMN/dmn-gs-new-project-creating-proc.adoc[leveloffset=+1]

include::DMN/dmn-con.adoc[leveloffset=+1]
include::DMN/dmn-gs-creating-drd-proc.adoc[leveloffset=+2]
include::DMN/dmn-gs-creating-custom-datatypes-proc.adoc[leveloffset=+2]
include::DMN/dmn-gs-assigning-custom-datatypes-proc.adoc[leveloffset=+2]
include::DMN/dmn-gs-defining-decision-logic-proc.adoc[leveloffset=+2]

include::AuthoringAssets/test-scenarios-intro-con.adoc[leveloffset=+1]
include::DMN/dmn-gs-testing-test-scenario-proc.adoc[leveloffset=+2]

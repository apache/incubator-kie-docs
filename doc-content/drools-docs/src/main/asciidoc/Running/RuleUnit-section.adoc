...
|onStart()
|the {ENGINE} starts evaluating the unit
...
rule unit acts as a guard for a different unit. This means that, when the {ENGINE} produces at least one match for the LHS

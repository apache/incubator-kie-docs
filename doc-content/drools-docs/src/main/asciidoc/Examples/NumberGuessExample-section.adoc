...
If you do this _before_ you select any item on the rule flow (or click the blank space in the rule flow) you should be presented with the following set of properties.
...
To see how this works, click the "Guess Correct Node"; then within the Properties View, open the Constraints Editor by clicking the button at the right that appears once you click the "Constraints" property line.
...
Click the "Edit" button beside "To node Too High" and you'll see a dialog like the one below.

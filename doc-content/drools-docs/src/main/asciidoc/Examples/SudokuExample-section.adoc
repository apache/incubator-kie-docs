...
.Initial screen
image::droolsImages/Examples/SudokuExample/sudoku1.png[align="center"]

Loading the "Simple" example fills the grid according to the puzzle's initial state.

.After loading "Simple"
image::droolsImages/Examples/SudokuExample/sudoku2.png[align="center"]
...
."Simple" Solved
image::droolsImages/Examples/SudokuExample/sudoku3.png[align="center"]
...
image::droolsImages/Examples/SudokuExample/sudoku4.png[align="center"]
...
.Broken "solved" state
image::droolsImages/Examples/SudokuExample/sudoku5.png[align="center"]

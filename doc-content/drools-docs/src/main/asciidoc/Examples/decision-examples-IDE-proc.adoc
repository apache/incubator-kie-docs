...
.Procedure
ifdef::DM,PAM[]
. Download and unzip the *{PRODUCT} {PRODUCT_VERSION} - Source Distribution* from the https://www.ibm.com/support/pages/node/6596913[IBM Support] page to a temporary directory, such as `/{PRODUCT_FILE}-sources`.
endif::[]
ifdef::DROOLS,JBPM,OP[]

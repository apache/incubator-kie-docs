...
. Select each asset to explore how the project is designed to achieve the specified goal or workflow. Some of the sample projects contain more than one page of assets.
. To view the full asset list, click the left or right arrows in the upper-right corner of the project.
+

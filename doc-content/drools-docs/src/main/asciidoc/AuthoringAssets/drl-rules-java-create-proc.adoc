...
----
+
. Download the *{PRODUCT} {PRODUCT_VERSION_LONG} Source Distribution* ZIP file from the https://www.ibm.com/support/pages/node/6596913[IBM Support] page and extract it under
ifdef::PAM[]

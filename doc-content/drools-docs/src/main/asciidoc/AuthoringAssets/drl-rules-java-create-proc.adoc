...
----
+
. Download the *{PRODUCT} {PRODUCT_VERSION} - Source Distribution* ZIP file from the {PRODUCT_DOWNLOAD_LINK}[IBM Business Automation Manager Open Editions {ENTERPRISE_VERSION} downloads] page  and extract it under
ifdef::PAM[]

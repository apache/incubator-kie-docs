...
.Data enumeration
image::droolsImages/Workbench/AuthoringAssets/EnumConfig.png[align="center"]
...
image::droolsImages/Workbench/AuthoringAssets/EnumVehicleEngine.png[align="center"]

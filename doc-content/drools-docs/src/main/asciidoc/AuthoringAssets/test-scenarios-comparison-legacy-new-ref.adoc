...
IMPORTANT: The new test scenario designer has an improved layout and feature set and continues to be developed. However, the legacy test scenario designer is deprecated with  Red Hat Process Automation Manager 7.3.0 and will be removed in a future {PRODUCT} release.

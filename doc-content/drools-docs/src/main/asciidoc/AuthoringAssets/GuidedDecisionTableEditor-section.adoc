...
image::droolsImages/Workbench/AuthoringAssets/dtable-extended-entry.png[align="center"]
...
image::droolsImages/Workbench/AuthoringAssets/dtable-limited-entry.png[align="center"]
...
.Radar
image::droolsImages/Workbench/AuthoringAssets/dtable-radar.png[align="center"]
...
.Context menu
image::droolsImages/Workbench/AuthoringAssets/dtable-context-menu.png[align="center"]
...
.Cell merging
image::droolsImages/Workbench/AuthoringAssets/dtable-merged.png[align="center"]
...
.Cell grouping
image::droolsImages/Workbench/AuthoringAssets/dtable-grouped.png[align="center"]
...
.Selecting the wizard
image::droolsImages/Workbench/AuthoringAssets/dtable-wizard1.png[align="center"]
...
.Summary page
image::droolsImages/Workbench/AuthoringAssets/dtable-wizard2.png[align="center"]
...
.Add Fact Patterns page
image::droolsImages/Workbench/AuthoringAssets/dtable-wizard3.png[align="center"]
...
.Add Constraints page
image::droolsImages/Workbench/AuthoringAssets/dtable-wizard4.png[align="center"]
...
.Add Actions to update facts page
image::droolsImages/Workbench/AuthoringAssets/dtable-wizard5.png[align="center"]

[[_drools.guideddecisiontableeditorwizardinsertfactspage]]
==== Add Actions to insert facts page

Actions can also be defined to insert new Facts into the {ENGINE}.
...
.Add Actions to insert facts page
image::droolsImages/Workbench/AuthoringAssets/dtable-wizard6.png[align="center"]
...
.Columns to expand page
image::droolsImages/Workbench/AuthoringAssets/dtable-wizard7.png[align="center"]
...
.New column wizard
image::droolsImages/Workbench/AuthoringAssets/dtable-add-column-wizard.png[align="center"]
...
The User has the option to notify the {ENGINE} of the modified values which could lead to other rules being re-activated.
...
image::droolsImages/Workbench/AuthoringAssets/dtable-column-condition-brl1-popup.png[align="center"]

.The resulting decision table
image::droolsImages/Workbench/AuthoringAssets/dtable-column-condition-brl2-popup.png[align="center"]
...
image::droolsImages/Workbench/AuthoringAssets/dtable-column-action-brl1-popup.png[align="center"]


.The resulting decision table
image::droolsImages/Workbench/AuthoringAssets/dtable-column-action-brl2-popup.png[align="center"]
...
.Edit column
image::droolsImages/Workbench/AuthoringAssets/dtable-edit-column.png[align="center"]
...
image::droolsImages/Workbench/AuthoringAssets/dtable-column-hint.png[align="center"]
====
...
image::droolsImages/Workbench/AuthoringAssets/guided-dtable-selecting-hit-policy.png[align="center"]

Once the table is viewed in the editor. The hit policy that is being used can be seen in the top left corner of the table.

.Hit Policy
image::droolsImages/Workbench/AuthoringAssets/guided-dtable-hit-policy.png[align="center"]
...
.An empty audit log
image::droolsImages/Workbench/AuthoringAssets/guided-dtable-audit-log1.png[align="center"]
...
image::droolsImages/Workbench/AuthoringAssets/guided-dtable-audit-log2.png[align="center"]
...
The end result may be different on each time the rules are ran and with each {ENGINE} software version.

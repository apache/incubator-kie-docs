...
In other cases it is required that the propagation is eager, meaning that it is not immediate, but anyway has to happen before the {DECISION_ENGINE}/agenda starts scheduled evaluations.

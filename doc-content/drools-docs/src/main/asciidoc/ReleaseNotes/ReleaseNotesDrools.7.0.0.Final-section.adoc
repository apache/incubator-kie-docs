...
image::droolsImages/Workbench/ReleaseNotes/composite-field-constraint-formulae1.png[]

.Composite field constraint - Formula editor
image::droolsImages/Workbench/ReleaseNotes/composite-field-constraint-formulae2.png[]
...
.New editor
image::droolsImages/Workbench/ReleaseNotes/dtables-new-editor.png[]

.New editor - multiple open tables
image::droolsImages/Workbench/ReleaseNotes/dtables-new-editor-multiple.png[]

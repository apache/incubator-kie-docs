...
* *Regular execution:* usually, when running rules in production, the application will require a real time clock that allows the {ENGINE} to react immediately to the time progression.

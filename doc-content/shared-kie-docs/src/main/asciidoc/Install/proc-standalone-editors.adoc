...
You can install the standalone editors in the following ways:
...
* Use the NPM package
//COMMENT is this option being removed for 7.12?
...
--
ifdef::DROOLS,JBPM,OP[]
*Use hosted JavaScript files directly*: For this method, add the following `<script>` tags to your HTML page where `<YOUR_PAGE>` is the name of your project:

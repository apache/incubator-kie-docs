...
----
+
This command generates a Maven project with required dependencies and generates required directories and files to build your business application. You can use the Git versio control system (recommended) when developing a project.
+

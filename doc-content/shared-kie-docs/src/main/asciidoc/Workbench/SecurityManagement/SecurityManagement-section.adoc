...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementUsersExplorer.png[]
...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementUsersSearch.png[]
...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementNewUserForm.png[]
...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementViewUser.png[]

Same screen but when using the Keycloak security provider looks as:


image::sharedImages/Workbench/SecurityManagement/SecurityManagementViewUserKC.png[]
...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementEditUser.png[]
...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementUserPermissions.png[]
...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementUserAttributes.png[]
...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementGroupsSelection.png[]
...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementRolesSelection.png[]
...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementChangePassword.png[]

* *Deleting users*
+
The user currently being edited can be deleted from the realm by clicking on the _Delete_ button.

image::sharedImages/Workbench/SecurityManagement/SecurityManagementDeleteUser.png[]
...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementGroupsExplorer.png[]
...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementGroupsSearch.png[]
...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementNewGroup.png[]

After typing a name anc clicking _Save_, the next step is to assign users to it:
+

image::sharedImages/Workbench/SecurityManagement/SecurityManagementNewGroupUserSelection.png[]
...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementRolesExplorer.png[]
...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementEditRole.png[]
...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementRolesSearch.png[]
...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementSecuritySettsEditor.png[]
+
...
image::sharedImages/Workbench/SecurityManagement/SecurityManagementPerspectiveDenied.png[]

The opposite, _deny all grant a few_ strategy is also supported:

image::sharedImages/Workbench/SecurityManagement/SecurityManagementPerspectiveGranted.png[]

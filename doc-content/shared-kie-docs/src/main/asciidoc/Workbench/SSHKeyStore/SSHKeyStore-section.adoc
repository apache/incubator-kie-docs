...
By default, it uses the Workbench ``.security`` folder as a root path. It is possible to use a custom storage path
...
. Log in to the Workbench and click the gear icon next to your login to open the *Admin* page.
+

...
image::sharedImages/Workbench/General/home.png[align="center"]
...
image::sharedImages/Workbench/General/workbenchStructureOverview.png[align="center"]
...
image::sharedImages/Workbench/General/Space.png[align="center"]

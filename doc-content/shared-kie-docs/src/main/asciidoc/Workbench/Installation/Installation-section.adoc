...
* **``org.uberfire.nio.git.http.host``**: If the HTTP daemon is enabled, it uses this property as local host identifier. This is an informative property, as the HTTP will rely on servlet container, however this is used to display how to get access the git over HTTP. This is an informative property, as the HTTP will rely on servlet container, however this is used to display how to get access the git over HTTP. Default: `localhost`
* **``org.uberfire.nio.git.http.hostname``**: If the HTTP daemon is enabled, it uses this property as local host name identifier. This is an informative property, as the HTTP will rely on servlet container, however this is used to display how to get access the git over HTTP. Default: `localhost`
* **``org.uberfire.nio.git.http.port``**: If the HTTP daemon is enabled, it uses this property as port number. This is an informative property, as the HTTP will rely on servlet container, however this is used to display how to get access the git over HTTP. Default: `8080`
* **``org.uberfire.nio.git.https.enabled``**: Enables or disables the HTTPS daemon. Default: `false`
* **``org.uberfire.nio.git.https.host``**: If the HTTPS daemon is enabled, it uses this property as local host identifier. This is an informative property, as the HTTPS will rely on servlet container, however this is used to display how to get access the git over HTTPS. This is an informative property, as the HTTPS will rely on servlet container, however this is used to display how to get access the git over HTTPS. Default: `localhost`
* **``org.uberfire.nio.git.https.hostname``**: If the HTTPS daemon is enabled, it uses this property as local host name identifier. This is an informative property, as the HTTP will rely on servlet container, however this is used to display how to get access the git over HTTPS. Default: `localhost`
* **``org.uberfire.nio.git.https.port``**: If the HTTP daemon is enabled, it uses this property as port number. This is an informative property, as the HTTP will rely on servlet container, however this is used to display how to get access the git over HTTP. Default: `8443`

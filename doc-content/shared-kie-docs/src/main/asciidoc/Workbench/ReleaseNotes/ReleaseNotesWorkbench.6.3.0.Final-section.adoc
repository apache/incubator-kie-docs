...
.ACE Editor
image::sharedImages/Workbench/ReleaseNotes/drl-ace-editor.png[]
...
image::sharedImages/Workbench/ReleaseNotes/DataModelEditingWithLock.png[]


.Locked assets cannot be edited by other users
image::sharedImages/Workbench/ReleaseNotes/DataModelLocked.png[]
...
image::sharedImages/Workbench/ReleaseNotes/DM-DroolsDomainToolWindow6.3.png[]


.Persistence tool window
image::sharedImages/Workbench/ReleaseNotes/DM-JPADomainToolWindow6.3.png[]


.Advanced configurations tool window
image::sharedImages/Workbench/ReleaseNotes/DM-AdvancedDomainToolWindow6.3.png[]
...
.New Data Object
image::sharedImages/Workbench/ReleaseNotes/DM-NewDataObject6.3.png[]
...
image::sharedImages/Workbench/ReleaseNotes/DM-DataObjectJPADomainTab6.3.png[]

+

.Field level JPA domain editor
image::sharedImages/Workbench/ReleaseNotes/DM-FieldJPADomainTab6.3.png[]
* Persistence configuration screen was added to the project editor.
+

.Persistence configuration
image::sharedImages/Workbench/ReleaseNotes/DM-Persistence-Configuration6.3.png[]
...
image::sharedImages/Workbench/ReleaseNotes/DataSetAuthoringPerspective.png[]

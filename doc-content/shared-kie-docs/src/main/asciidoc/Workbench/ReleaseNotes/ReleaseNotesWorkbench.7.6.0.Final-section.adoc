...
image::sharedImages/Workbench/ReleaseNotes/ContentManagement/ContentManagementEnhancements.png[align="center"]
...
image::sharedImages/Workbench/ReleaseNotes/ContentManagement/NewPagePopup.png[align="center"]

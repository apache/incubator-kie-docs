...
image::sharedImages/Workbench/ReleaseNotes/zip_repo.png[]


.Download a folder
image::sharedImages/Workbench/ReleaseNotes/zip_folder.png[]
...
image::sharedImages/Workbench/ReleaseNotes/NewGuidedDecisionTableWizardValidation.png[]
...
image::sharedImages/Workbench/ReleaseNotes/NewGuidedDecisionTableWizard.png[]
...
.Improved Metadata Tab
image::sharedImages/Workbench/ReleaseNotes/ImprovedMetadataWidget.jpg[]
...
.Versions history
image::sharedImages/Workbench/ReleaseNotes/ImprovedVersionsHistory.jpg[]
* Metadata
+ 
...
.Metadata section
image::sharedImages/Workbench/ReleaseNotes/ImprovedMetadatSection.jpg[]
* Comments area
+ 
...
.Version selection dropdown
image::sharedImages/Workbench/ReleaseNotes/ImprovedVersionsSelector.jpg[]
...
image::sharedImages/Workbench/ReleaseNotes/NewJavaEditor.png[]
...
.Usages detection
image::sharedImages/Workbench/ReleaseNotes/UsagesDetection.png[]
...
image::sharedImages/Workbench/ReleaseNotes/NewExecutionServerManagementPerspective.png[]
...
image::sharedImages/Workbench/ReleaseNotes/TimelinePerspective.png[]
...
.People Perspective
image::sharedImages/Workbench/ReleaseNotes/PeoplePerspective.png[]


.Edit User Info
image::sharedImages/Workbench/ReleaseNotes/PeoplePerspective1.png[]
...
image::sharedImages/Workbench/ReleaseNotes/ContributorsPerspective.png[]
...
.Package selector
image::sharedImages/Workbench/ReleaseNotes/PackageSelector.png[]
...
image::sharedImages/Workbench/ReleaseNotes/GuidedDecisionTableNewPopup.png[]


.Example Guided Rule Editor popup
image::sharedImages/Workbench/ReleaseNotes/GuidedRuleNewPopup.png[]
...
image::sharedImages/Workbench/ReleaseNotes/GuidedDecisionTree1.png[]
...
image::sharedImages/Workbench/ReleaseNotes/CreateRepositoryWizard1.png[]


.Create Repository Wizard 2/2
image::sharedImages/Workbench/ReleaseNotes/CreateRepositoryWizard2.png[]
...
image::sharedImages/Workbench/ReleaseNotes/ManagedRepositoryStructureScreen.png[]


.Repository Structure Screen for an Unmanaged Repository
image::sharedImages/Workbench/ReleaseNotes/UnManagedRepositoryStructureScreen.png[]

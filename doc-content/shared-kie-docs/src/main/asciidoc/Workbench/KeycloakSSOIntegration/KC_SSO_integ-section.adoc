...
In order to authenticate those services thorough Keycloak apply those modifications for the _WEB-INF/web.xml_ file (app deployment descriptor) from jBPM's WAR file:

...
{CENTRAL} provides an administration area which provides user, group and role management features (see xref:business-central-security-management-con_{context}[Security management] section).

...
image::sharedImages/Workbench/Authoring/ArtifactRepository/mavenRepositoryExplorer.png[align="center"]
...
image::sharedImages/Workbench/Authoring/ArtifactRepository/mavenRepositoryUpload.png[align="center"]

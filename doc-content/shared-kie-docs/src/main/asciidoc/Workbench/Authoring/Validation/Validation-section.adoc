...
.The Problems Panel
image::sharedImages/Workbench/Authoring/Validation/workbench-problems-panel.png[align="center"]
...
image::sharedImages/Workbench/Authoring/Validation/workbench-validation.png[align="center"]

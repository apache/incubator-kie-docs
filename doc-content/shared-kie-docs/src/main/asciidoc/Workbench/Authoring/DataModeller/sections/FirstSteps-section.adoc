...
image::sharedImages/Workbench/Authoring/DataModeller/authoring.jpg[align="center"]
...
image::sharedImages/Workbench/Authoring/DataModeller/open_data_model.jpg[align="center"]
...
image::sharedImages/Workbench/Authoring/DataModeller/6.3/overview.png[align="center"]
...
.New field creation
image::sharedImages/Workbench/Authoring/DataModeller/6.3/create-new-field.png[align="center"]
...
image::sharedImages/Workbench/Authoring/DataModeller/6.3/data-object-field-browser.png[align="center"]
...
image::sharedImages/Workbench/Authoring/DataModeller/6.3/data-object-selector.png[align="center"]

+

.Data Object general properties
image::sharedImages/Workbench/Authoring/DataModeller/6.3/data-object-general-properties.png[align="center"]
...
.Field selector
image::sharedImages/Workbench/Authoring/DataModeller/6.3/field-selector.png[align="center"]



.Field general properties
image::sharedImages/Workbench/Authoring/DataModeller/6.3/field-general-properties.png[align="center"]
...
image::sharedImages/Workbench/Authoring/DataModeller/6.3/tool-window-selector.png[align="center"]

+

.Drools & jBPM tool window
image::sharedImages/Workbench/Authoring/DataModeller/6.3/data-object-drools-tool-window.png[align="center"]

+

.OptaPlanner tool window
image::sharedImages/Workbench/Authoring/DataModeller/6.3/data-object-optaplanner-tool-window.png[align="center"]
...
image::sharedImages/Workbench/Authoring/DataModeller/6.3/data-object-persistence-tool-window.png[align="center"]

+

.Advanced tool window
image::sharedImages/Workbench/Authoring/DataModeller/6.3/data-object-or-field-advanced-tool-window.png[align="center"]
...
.Source editor
image::sharedImages/Workbench/Authoring/DataModeller/6.3/source-editor-tab.png[align="center"]

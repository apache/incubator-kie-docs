...
.Project editor.
image::sharedImages/Workbench/Authoring/DataModeller/add-dependency-1.png[align="center"]


=== Click on the "Add" button to add a new dependency line.

.New dependency line.
image::sharedImages/Workbench/Authoring/DataModeller/add-dependency-2.png[align="center"]


=== Complete the GAV for the JAR file already installed in local M2 repository. 

.Dependency line edition.
image::sharedImages/Workbench/Authoring/DataModeller/add-dependency-3.png[align="center"]
...
.Save project.
image::sharedImages/Workbench/Authoring/DataModeller/add-dependency-4.png[align="center"]
...
image::sharedImages/Workbench/Authoring/DataModeller/add-dependency-guvnor-m2-1.png[align="center"]


=== Browse your local file system and select the JAR file to be uploaded using the Browse button. 

.File browser.
image::sharedImages/Workbench/Authoring/DataModeller/add-dependency-guvnor-m2-2-2.png[align="center"]


=== Upload the file using the Upload button.

.File upload success.
image::sharedImages/Workbench/Authoring/DataModeller/add-dependency-guvnor-m2-3.png[align="center"]
...
.Files list.
image::sharedImages/Workbench/Authoring/DataModeller/add-dependency-guvnor-m2-4.png[align="center"]
...
.Not valid POM.
image::sharedImages/Workbench/Authoring/DataModeller/add-dependency-guvnor-m2-not-gav-1.png[align="center"]


.Enter GAV manually.
image::sharedImages/Workbench/Authoring/DataModeller/add-dependency-guvnor-m2-not-gav-2.png[align="center"]
...
image::sharedImages/Workbench/Authoring/DataModeller/add-dependency-guvnor-m2-5.png[align="center"]
...
image::sharedImages/Workbench/Authoring/DataModeller/add-dependency-select-external-pojo.png[align="center"]

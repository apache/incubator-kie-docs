...
.Creating Tags
image::sharedImages/Workbench/Authoring/TagsEditor/CreatingTags.png[align="center"]


Once you created new Tags they will appear over the Editor allowing you to remove them by pressing on them if you want. 

.Existing Tags
image::sharedImages/Workbench/Authoring/TagsEditor/ExistingTags.png[align="center"]

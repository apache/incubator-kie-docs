...
You can add subcases to your case definition using the process designer. A subcase is another case within your case project, similar to having a sub-process within your process. Subcases can also be added to a regular business process, which enables you to start a case from within a process instance.
...
DataAccess_XXX::
Optional data access restrictions where `XXX` is the name of a data item and the `value` is the access restrictions.
DestroyOnAbort::

...
image::jbpmImages/Console/process-management.png[]
...
image::jbpmImages/Console/process-definitions-list.png[]
...
image::jbpmImages/Console/process-definitions-details.png[]

Notice that you can View the Process Model (Read Only mode) selecting 'Diagram' tab .

image::jbpmImages/Console/process-model.png[]
...
image::jbpmImages/Console/process-definitions-new-instance.png[]
...
image::jbpmImages/Console/process-instances-list.png[]
...
image::jbpmImages/Console/process-instances-details.png[]
...
image::jbpmImages/Console/process-instances-error.png[align="center", title="View related error when it exists"]
...
image::jbpmImages/Console/process-instance-signal.png[align="center", title="Signal popup"]
...
image::jbpmImages/Console/process-instances-process-id-variables.png[]
...
image::jbpmImages/Console/process-instances-variables.png[]
...
image::jbpmImages/Console/process-instances-documents.png[]
...
image::jbpmImages/Console/process-instances-logs.png[]
...
image::jbpmImages/Console/process-instances-running-model.png[]
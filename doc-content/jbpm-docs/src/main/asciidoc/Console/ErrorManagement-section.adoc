...
image::jbpmImages/Console/errors-menu.png[align="center"]
...
image::jbpmImages/Console/errors-list.png[align="center"]
...
image::jbpmImages/Console/errors-details.png[align="center"]

...
image::jbpmImages/Console/process-instances-areas.png[]
...
image::jbpmImages/Console/ConsoleItemListFilters.png[align="center", title="Filters dock opened"]
...
image::jbpmImages/Console/console-datefilter.png[align="left", title="Date field filter opened"]
...
image::jbpmImages/Console/console-newAdvancedFilter.png[align="left", title="New Advanced filter popup"]
...
image::jbpmImages/Console/console-newAdvancedFilter_2.png[align="left", title="New Advanced filter: select column"]
...
image::jbpmImages/Console/console-newAdvancedFilter_3.png[align="left", title="New Advanced filter: define condition over selected column"]
...
image::jbpmImages/Console/ConsoleItemListSavedFilters.png[align="center", title="Saved filters dock opened"]
...
image::jbpmImages/Console/ConsoleItemListSavedFiltersError.png[align="center", title="Not allowed save filter with the same existing filter name"]
...
image::jbpmImages/Console/ConsoleManageSelector.png[title="Manage screen selector"]
...
image::jbpmImages/Console/process-instances-column_selector.png[]

The number of items to show in a page can be configurable too, from the page size dropdown list

image::jbpmImages/Console/process-instances-number-items.png[]
...
image::jbpmImages/Console/process-instances-specific-area.png[]
...
image::jbpmImages/Console/ConsoleItemList.png[align="center", title="Item list design"]

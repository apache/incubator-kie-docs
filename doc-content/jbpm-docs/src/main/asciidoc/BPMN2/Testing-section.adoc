...
image::jbpmImages/BPMN2/HelloWorld.png[]
...
public class ProcessPersistenceTest extends JbpmJUnitBaseTestCase {
    ...
    public void testProcess() {
        ...
        // take RuntimeManager to work with {ENGINE}
...
image::jbpmImages/BPMN2/HelloWorld2.png[]
...
public class ProcessHumanTaskTest extends JbpmJUnitBaseTestCase {
    ...
    public ProcessHumanTaskTest() {
        // configure this tests to not use persistence for {ENGINE} but still use it for human tasks
        super(true, false);
    }
}
----

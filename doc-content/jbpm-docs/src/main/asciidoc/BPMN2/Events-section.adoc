...
.Start event
image::jbpmImages/BPMN2/StartEvent.png[]
...
.End event
image::jbpmImages/BPMN2/EndEvent.png[]
...
.Throwing error event
image::jbpmImages/BPMN2/ErrorEndEvent.png[]
...
.Catching timer event
image::jbpmImages/BPMN2/IntermediateTimerEvent.png[]
...
.Catching signal event
image::jbpmImages/BPMN2/IntermediateSignalEvent.png[]

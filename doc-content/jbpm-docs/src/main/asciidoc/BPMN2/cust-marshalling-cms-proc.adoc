...
. Enter the identifier of the custom document marshalling strategy, such as `org.jbpm.integration.cmis.impl.OpenCMISPlaceholderResolverStrategy` in this example.

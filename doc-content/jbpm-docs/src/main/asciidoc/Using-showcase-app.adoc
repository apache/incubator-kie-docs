...
* The *IT_Orders* sample project has been imported in {CENTRAL} and deployed to the {KIE_SERVER}. For more information about case management, see {URL_GETTING_STARTED}#assembly-getting-started-case-management[_{GETTING_STARTED_CASES}_].

...
image::jbpmImages/BusinessApplications/deployment-descriptor-work-item-handler.png[]
...
triggered by the {ENGINE}. Supported event listener types are
...
image::jbpmImages/BusinessApplications/deployment-descriptor-event-listener.png[]

...
To get started with business applications the easiest way is to generate it using maven archetype commands. Please refer <<_ch.createapplication, Create your business application>>.

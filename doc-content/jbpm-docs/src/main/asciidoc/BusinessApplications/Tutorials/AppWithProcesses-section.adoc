...
image::jbpmImages/BusinessApplications/tutorial-2-process.png[Business process - sample]
...
image::jbpmImages/BusinessApplications/tutorial-2-empty-server.png[]
...
image::jbpmImages/BusinessApplications/tutorial-2-process-def.png[]
...
image::jbpmImages/BusinessApplications/tutorial-2-process-instance.png[]
...
image::jbpmImages/BusinessApplications/tutorial-2-task-list.png[]

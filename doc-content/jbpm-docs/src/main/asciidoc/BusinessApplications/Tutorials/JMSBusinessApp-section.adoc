...
To get started with business applications the easiest way is to generate it using maven archetype commands. Refer to Create your business application section for the commands.
...
URL: `http://localhost:8090/rest/server/containers/<project>-kjar/processes/catchsignalprocess/instances`
...
URL: `http://localhost:8090/rest/server/containers/<project>-kjar/processes/throwsignalprocess/instances`
...
Let's deploy the <project>-kjar to our running application.

...
image::jbpmImages/BusinessApplications/business-app-start-page.png[Business application landing page]
...
image::jbpmImages/BusinessApplications/exec-server-empty.png[Connected business application]
...
image::jbpmImages/BusinessApplications/exec-server-deployed.png[Connected business application with deployed project]

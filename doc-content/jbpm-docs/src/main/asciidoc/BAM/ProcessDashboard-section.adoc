...
image::jbpmImages/BAM/reports-menu.png[]
...
In this case, the database tables consumed are: _processinstancelog_ and _bamtasksummary_ both belonging to the {ENGINE}. 
...
image::jbpmImages/BAM/ProcessReports-header.png[]

.Process Reports dashboard view
image::jbpmImages/BAM/ProcessReports-dashboardView.png[]
...
from the {ENGINE} plus data coming from its own business domain.
====
...
image::jbpmImages/BAM/ProcessReports-filtered.png[]
...
.Task reports header
image::jbpmImages/BAM/TaskReports-header.png[]

.Task Reports dashboard view
image::jbpmImages/BAM/TaskReports-dashboardView.png[]

.Task Reports table view
image::jbpmImages/BAM/TaskReports-tableView.png[]

.Task details view
image::jbpmImages/BAM/TaskReports-taskDetail.png[]

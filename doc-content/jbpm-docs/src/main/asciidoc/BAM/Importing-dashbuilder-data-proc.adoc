...
//Where does this dashboard data come from? Is it dashboard data that I created in another BC instance?
You can import dashboard-related data to {CENTRAL} from a ZIP file if the archive is structured in the same way as the following example:
...
//We are really importing dashboards, right? To call it dashboard data I think is confusing with the data set section.

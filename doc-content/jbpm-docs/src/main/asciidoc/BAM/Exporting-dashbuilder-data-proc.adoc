...
= Exporting {CENTRAL} dashboards

You can export dashboard-related data such as data sets, pages, and navigation from {CENTRAL} as a ZIP file.

.Procedure
. In {CENTRAL}, select the *Admin* icon in the upper-right corner of the screen and select *Dashbuilder Data Transfer*.

. To export the dashboard-related data, complete any of the following tasks:
+
--
...
You can export all the dashboard-related data such as datasets from {CENTRAL} as a ZIP file.

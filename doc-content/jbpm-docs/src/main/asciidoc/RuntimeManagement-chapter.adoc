...
image::jbpmImages/RuntimeManagement/edit-deployment-desc.png[]
...
image::jbpmImages/RuntimeManagement/process-deployments.png[]
...
image::jbpmImages/RuntimeManagement/deployed-unit-list.png[]
...
image::jbpmImages/RuntimeManagement/build-and-deploy.png[]
...
image::jbpmImages/RuntimeManagement/new-deployment.png[]

...
{CENTRAL} enables configuration of access restrictions to repositories (see xref:business-central-security-management-con_{context}[Security management] section for how this can be done).

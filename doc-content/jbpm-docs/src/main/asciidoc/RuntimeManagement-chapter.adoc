...
{CENTRAL} enables configuration of access restrictions to repositories (see xref:con-business-central-security-management_{context}[Security management] section for how this can be done).

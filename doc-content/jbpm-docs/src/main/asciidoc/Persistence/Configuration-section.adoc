...
If you would like to manually add the necessary dependencies to your project, you need to put the JAR file [path]_jbpm-persistence-jpa.jar_ on your project's classpath

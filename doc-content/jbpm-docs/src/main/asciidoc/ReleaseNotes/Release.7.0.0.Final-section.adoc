...
.Case List building block, list the cases that are accessible by the user
...
completely rewritten from scratch and it is fully integrated into the workbench.

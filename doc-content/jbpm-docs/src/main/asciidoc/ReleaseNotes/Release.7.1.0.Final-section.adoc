...
image::ReleaseNotes/StunnerEmbeddedSubprocessRules.png[align="center", title="BPMN Embedded sub-process - Example trying to create connection from the sub-process, it results invalid due to BPMN specification constraints"]

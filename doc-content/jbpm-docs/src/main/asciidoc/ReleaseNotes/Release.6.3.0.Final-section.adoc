...
[source]
----
{server}/business-process/rest/runtime/{deploymentId}/process/{processDefId}/image
----
+
...
[source]
----
{server}/business-process/rest/runtime/{deploymentId}/process/{processDefId}/image/{procInstId}
----
+

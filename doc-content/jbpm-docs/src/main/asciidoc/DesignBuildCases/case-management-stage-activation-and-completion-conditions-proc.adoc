...
.Procedure
. With the stage selected, click image:getting-started/diagram_properties.png[Properties icon] to open the *Properties* panel on the right side of the designer.

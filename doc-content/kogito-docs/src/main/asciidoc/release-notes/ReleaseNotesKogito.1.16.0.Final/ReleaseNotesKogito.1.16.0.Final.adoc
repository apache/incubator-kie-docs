...
=== Kogito Serverless Workflow support for Event Data Filters and Data Merging for Events

In this release, we expanded the {PRODUCT} runtime support to the Serverless Workflow specification by implementing support to {SERVERLESS_WORKFLOW_REPO_URL_BASE}/blob/0.6.x/specification.md#event-data-filters[Event Data Filters] and {SERVERLESS_WORKFLOW_REPO_URL_BASE}/blob/0.6.x/specification.md#data-merging[Data Merging] for Events.
You can also explore the example https://github.com/kiegroup/kogito-examples/tree/1.16.x/kogito-quarkus-examples/serverless-workflow-callback-quarkus[serverless-workflow-callback-quarkus] on how to use Event Data Filters and Data Merging in your {PRODUCT} project.

...
The https://github.com/apache/incubator-kie-kogito-examples/tree/stable/kogito-quarkus-examples/serverless-workflow-saga-quarkus[serverless-workflow-saga-quarkus] example application is based on Quarkus runtime.
...
You can also see the https://github.com/apache/incubator-kie-kogito-examples/tree/1.16.x/kogito-quarkus-examples/serverless-workflow-foreach-quarkus[serverless-workflow-foreach-quarkus] example application on how to use state data filters in your {PRODUCT} project.
...
For more information on how to use data merging and action data filters, see the https://github.com/apache/incubator-kie-kogito-examples/tree/1.16.x/kogito-quarkus-examples/serverless-workflow-expression-quarkus[serverless-workflow-expression-quarkus] example application.
...
For more information about how to use event data filters and data merging, see the https://github.com/apache/incubator-kie-kogito-examples/tree/1.16.x/kogito-quarkus-examples/serverless-workflow-callback-quarkus[serverless-workflow-callback-quarkus] example application.

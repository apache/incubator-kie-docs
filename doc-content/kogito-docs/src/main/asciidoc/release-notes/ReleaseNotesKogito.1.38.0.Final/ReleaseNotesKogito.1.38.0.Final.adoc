...
Starting from this release, a new Quarkus extensions is available to integrate RocksDB as persistence option to {PRODUCT} runtimes. The use the new extension, simply add as dependency to the project:

...
You can also explore the new example https://github.com/apache/incubator-kie-kogito-examples/tree/stable/kogito-quarkus-examples/serverless-workflow-compensation-quarkus[serverless-workflow-compensation-quarkus] on how to use compensation in your {PRODUCT} project.

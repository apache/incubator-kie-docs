...
=== {PRODUCT} Data Index service new Gateway API to connect with other {PRODUCT} runtime services

{PRODUCT} Data Index GraphQL API has been extended with a set of mutations that allow performing
operations in different {PRODUCT} services:
...
=== {PRODUCT} Data Index service API queries extended to get data from {PRODUCT} runtime services
The queries also have been extended to retrieve data from runtimes {PRODUCT} services, allowing get:

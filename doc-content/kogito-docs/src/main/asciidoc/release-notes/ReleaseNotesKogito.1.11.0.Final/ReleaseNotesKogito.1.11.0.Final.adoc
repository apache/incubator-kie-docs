...
==== {PRODUCT} Data Index service incorporated new API To connect with other {PRODUCT} services

New GraphQL queries and mutations have been added to allow performing operations in different {PRODUCT} services:
The new operations added are:
...
The queries also have been extended to retrieve from runtimes {PRODUCT} services:

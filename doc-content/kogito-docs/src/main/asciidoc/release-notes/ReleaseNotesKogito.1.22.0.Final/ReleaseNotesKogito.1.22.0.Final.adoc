...
Now {PRODUCT} data index can process domain data that incorporates collections in the model. Those collections are now included as a part of the {PRODUCT} data index GraphQL schema.

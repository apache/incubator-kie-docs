...
However, this format has some limitations impacting on external clients and external plugins, across evolutions of the Kogito application being developed; for example, adding/removing DMN/Decisions models from your Kogito application does not guarantee a stable naming and ordering across evolutions of your Kogito application.

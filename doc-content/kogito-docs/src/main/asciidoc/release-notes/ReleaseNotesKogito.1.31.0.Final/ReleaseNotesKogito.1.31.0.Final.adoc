...
Starting from this release, a new operator, specific to Serverless Workflow is available in the Alpha version. For more details, see https://github.com/apache/incubator-kie-kogito-serverless-operator/blob/v1.31.0/README.md[README].
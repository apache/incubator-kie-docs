...
A https://github.com/apache/incubator-kie-kogito-apps/tree/main/jobs-service/kogito-addons-jobs-service/kogito-addons-quarkus-jobs-service-embedded[new addon] is available to make Job Service run embedded with the Kogito application, without requiring to deploy it as an external service.

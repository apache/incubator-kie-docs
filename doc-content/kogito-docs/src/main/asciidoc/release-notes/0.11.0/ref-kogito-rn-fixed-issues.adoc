...
* The layout for some BPMN processes from the {PRODUCT} examples repository is distorted in the {PRODUCT} BPMN modler in VSCode. [https://issues.redhat.com/browse/KOGITO-1658[KOGITO-1658]]

...
* https://issues.redhat.com/secure/ReleaseNote.jspa?projectId=12322421&version=12382540[{PRODUCT} {COMMUNITY_VERSION_FINAL}]
...
//include::ReleaseNotesKogito.1.23.0.Final/ReleaseNotesKogito.1.24.0.Final.adoc[leveloffset=+1]

...
==== Improvments to Jobs Management in the {PRODUCT} Management Console
...
For more information about the {PRODUCT} Management Console, see {URL_PROCESS_SERVICES}#con-management-console_kogito-developing-process-services[].

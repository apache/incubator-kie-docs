...
==== Improved Jobs management page of Management console.

Description

Management console has some new features on the jobs management page,

* Options that allows us to view job details and to reschedule a job
* Controls to sort the table content in ascending or descending order
* Pagination controls to add new set of data on to the table

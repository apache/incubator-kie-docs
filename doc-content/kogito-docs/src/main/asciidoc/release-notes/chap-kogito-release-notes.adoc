...
You can now use the following example applications in the `kogito-examples` repository in Github to interact with a process in springboot using the {PRODUCT} Management and Task Console:

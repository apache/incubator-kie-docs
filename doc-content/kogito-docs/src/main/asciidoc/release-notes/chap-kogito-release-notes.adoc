...
If using Infinispan persistence add-on for persistence, starting from this release, we recommend upgrading to version Infinispan version 12.1.4. For upgrading details on Infinispan, please visit the https://infinispan.org/docs/stable/titles/upgrading/upgrading.html[Infinispan upgrade guide].
...
If using Data Index or Jobs service with Infinispan persistence, starting from this release, we upgraded the minimum required version
to be Infinispan 12.1.4. For upgrading details on Infinispan, please visit the https://infinispan.org/docs/stable/titles/upgrading/upgrading.html[Infinispan upgrade guide].

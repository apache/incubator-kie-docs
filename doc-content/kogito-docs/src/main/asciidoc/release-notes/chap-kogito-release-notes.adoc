...
* https://issues.redhat.com/secure/ReleaseNote.jspa?projectId=12322421&version=12353779[{PRODUCT} {COMMUNITY_VERSION_FINAL}]
** https://issues.redhat.com/secure/ReleaseNote.jspa?projectId=12322421&version=12374857[{PRODUCT} tooling 0.15.0]
...
include::ReleaseNotesKogito.1.14.0.Final/ReleaseNotesKogito.1.15.0.Final.adoc[leveloffset=+1]

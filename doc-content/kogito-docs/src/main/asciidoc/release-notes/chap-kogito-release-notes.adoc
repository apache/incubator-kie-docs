...
==== Additional properties for decision service node

You can now view additional details of a decision service node in the DMN designer. When a decision service node is selected, you can view the *Input Data*, *Encapsulated Decisions*, and *Output Decisions* in the *Properties* panel.

For more information about the decision service details, see {URL_DECISION_SERVICES}#ref-dmn-designer-nav_kogito-developing-decision-services[_{DECISION_SERVICES}_].

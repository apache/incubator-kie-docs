[id='con_phreak-rule-evaluation_{context}']
...
ifdef::KOGITO[]
image::HybridReasoning/LayeredMemory_enterprise.png[align="center"]
endif::[]
...
ifdef::KOGITO[]
image::HybridReasoning/segment1_enterprise.png[align="center"]
endif::[]
...
ifdef::KOGITO[]
image::HybridReasoning/segment2_enterprise.png[align="center"]
endif::[]
...
ifdef::KOGITO[]
image::HybridReasoning/segment3_enterprise.png[align="center"]
endif::[]
...
ifdef::KOGITO[]
image::HybridReasoning/segment4_enterprise.png[align="center"]
endif::[]
...
ifdef::KOGITO[]
image::HybridReasoning/segment5_enterprise.png[align="center"]
endif::[]

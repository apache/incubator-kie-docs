...
.Additional resources
ifdef::KOGITO[]
* {URL_DECISION_SERVICES}#con-audit-console_dmn-models[_{PRODUCT} Audit Investigation Console_]
endif::[]
ifdef::KOGITO-COMM[]
...
.Additional resources
ifdef::KOGITO[]
* {URL_PROCESS_SERVICES}#con-task-life-cycle_kogito-developing-process-services[_Task lifecycle in {PRODUCT} processes_]
endif::[]
ifdef::KOGITO-COMM[]

...
* `serverless-workflow-github-showcase`:  A Serverless Workflow service deployed as a GitHub "bot" application that will react upon a new PR being opened in a given GitHub project.

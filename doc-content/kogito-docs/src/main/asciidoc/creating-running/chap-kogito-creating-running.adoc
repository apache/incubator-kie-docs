...
=== {PRODUCT} add-ons
You can find multiple examples demonstrating {PRODUCT} add-ons in the https://github.com/kiegroup/kogito-examples[`{PRODUCT_INIT}-examples`] repository in GitHub. A sample of these include:

...
--
. After the {PRODUCT} service is running, use a REST client, curl utility, or the Swagger UI configured for the application (ex: \http://localhost:8080/q/swagger-ui or \http://localhost:8080/swagger-ui.html etc. depending on configuration) to send API requests with the following components:
+
--
...
For this example, use a REST client, curl utility, or the Swagger UI configured for the application (ex: \http://localhost:8080/q/swagger-ui or \http://localhost:8080/swagger-ui.html etc. depending on configuration) to send API requests with the following components:

...
$ ./target/sample-kogito-1.0-SNAPSHOT-runner
----
* It is also possible to use a container builder image. In this case you do not need to have installed GraalVM. A container with GraalVM will be automatically pulled. Please notice that in this case the resulting executable will be targeting a Linux kernel. In this case the command is
+
--

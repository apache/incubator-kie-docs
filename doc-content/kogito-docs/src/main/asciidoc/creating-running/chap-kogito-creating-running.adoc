...
* *Business Modeler standalone editors*: Enables you to view and design BPMN and DMN models embedded in your web applications. To download the necessary files, you can either use NPM artifacts from https://www.npmjs.com/package/@kogito-tooling/kie-editors-standalone[Kogito tooling] or download the JavaScript files directly for DMN standalone editor library at `https://kiegroup.github.io/kogito-online/standalone/dmn/index.js` and for BPMN standalone editor library at `https://kiegroup.github.io/kogito-online/standalone/bpmn/index.js`.
...
[role="_abstract"]
The standalone editors are distributed in a self-contained library that provides an all-in-one JavaScript file for each editor. The JavaScript file uses a comprehensive API to set and control the editor.

.Procedure
You can install the standalone editors using three approaches.
...
* For DMN editor, go to https://kiegroup.github.io/kogito-online/standalone/dmn/index.js.
* For BPMN editor, go to https://kiegroup.github.io/kogito-online/standalone/bpmn/index.js.

. Add downloaded Javascript files to your hosted application.
. Add the following `<script>` tag to your HTML page:
+
[source]
----
...
Use NPM package::
. Open https://www.npmjs.com/package/@kogito-tooling/kie-editors-standalone[Kogito tooling page] and download the NPM package.
...
.Usage
The API is same for each editor. The following is an example of how to open a DMN editor:
...
|`initialContent`
a|Promise to a DMN model content. This parameter can be empty, for example:
...
|Returns a promise containing SVG string of the current diagram.

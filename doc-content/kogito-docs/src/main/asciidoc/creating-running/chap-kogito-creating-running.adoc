...
With Spring Boot, you can create custom Maven projects using {PRODUCT} Spring Boot starter or {PRODUCT} add-ons. The {PRODUCT} Spring Boot starters include:
...
NOTE: When you pass an add-on to the property, the add-on name does not require the `kogito-addons-springboot` suffix. Also, you can combine the `add-ons` and `starters` properties to customize the project.
--
...
The https://docs.spring.io/spring-boot/docs/current/reference/htmlsingle/#using-boot-starter[Spring Boot starters] are a set of dependency descriptors that you can include in your {PRODUCT} application. Using Spring Boot starters, you can eliminate the need to go through sample code, and copy & pasting dependency descriptors.

When you create a project, the `pom.xml` file contains all the necessary starters. You can also include a new starter if required. For more information on creating projects using Spring Boot starter, see xref:proc-customizing-spring-boot-project-creation_kogito-creating-running[].
...
Starters for decisions such as DMN support for your {PRODUCT} Spring Boot project. You can add a {PRODUCT} decisions Spring Boot starter as follows:
...
Starters for predictions such as PMML support for your {PRODUCT} Spring Boot project. You can add a {PRODUCT} predictions Spring Boot starter as follows:
...
Starters for processes such as BPMN support for your {PRODUCT} Spring Boot project. You can add a {PRODUCT} processes Spring Boot starter as follows:
...
Starters for rules such as DRL support for your {PRODUCT} Spring Boot project. You can add a {PRODUCT} rules Spring Boot starter as follows:
...
Starters for the Serverless Workflow support for your {PRODUCT} Spring Boot project. You can add a {PRODUCT} Serverless Workflow starter as follows:

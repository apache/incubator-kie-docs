...
* `process-springboot-example`: A simple process service for ordering items using add-ons with Spring Boot.
...
MongoDB::
* `process-mongodb-persistence-springboot`: A quickstart project using add-ons that processes deals for travellers using MongoDb. 
* `process-mongodb-persistence-quarkus`: A quickstart project using add-ons that processes deals for travellers.
...
include::../bpmn/chap-kogito-developing-process-services.adoc[tag=process-man-add-on,leveloffset=+1]

include::../bpmn/chap-kogito-developing-process-services.adoc[tag=process-svg-add-on,leveloffset=+1]

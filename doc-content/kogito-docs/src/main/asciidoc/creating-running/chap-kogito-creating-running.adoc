...
*You can map different channels to the same topic if you wish to do so. 
...
By default, {PRODUCT} uses Cloud event json format for messaging. You can change the default format by providing your own https://github.com/kiegroup/kogito-runtimes/blob/main/api/kogito-events-api/src/main/java/org/kie/kogito/event/EventMarshaller.java[event marshaler] implementation. 

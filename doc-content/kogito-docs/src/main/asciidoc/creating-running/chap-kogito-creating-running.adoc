...
* *Business Modeler standalone editors*: Enables you to view and design BPMN and DMN models embedded in your own web applications.
To download the necessary files, you can use either our NPM artifacts at `https://www.npmjs.com/package/@kogito-tooling/kie-editors-standalone` or download the JavaScript files directly at `https://kiegroup.github.io/kogito-online/standalone/dmn/index.js` for the DMN standalone editor library and `https://kiegroup.github.io/kogito-online/standalone/bpmn/index.js` for the BPMN standalone editor library.
...
[role="_abstract"]
These editors are distributed in a self contained library that provides an all-in-one JavaScript file for each of them, that can be interacted using a comprehensive API for setup and control of them.

.Installation
There are three ways to install the standalone editors:

. Use our hosted JS files directly
+
* Add a `<script>` tag to you HTML page:
+
----
...
+
* Download the files:
** DMN Editor: https://kiegroup.github.io/kogito-online/standalone/dmn/index.js
** BPMN Editor: https://kiegroup.github.io/kogito-online/standalone/bpmn/index.js

...
The Source Files Add-on provides REST support for the following operations:

==== List all the source files for the current project

* GET: `/management/process/sources`

.Example: to list all the source files for the current project, use the following command:

[source,bash]
----
$ curl -X 'GET' \
  'http://localhost:8080/management/process/sources' \
  -H 'accept: application/json' \
...
----
{
  "demo.orders": [
    {
      "uri": "org/kie/kogito/examples/orders.bpmn2"
    }
  ],
  "ymlgreet": [
    {
      "uri": "org/kie/kogito/examples/ymlgreet.sw.yml"
    }
  ],
  "petstore": [
    {
    ...
    {
      "uri": "org/kie/kogito/examples/petstore.sw.json"
    }
  ],
  "jsongreet": [
    {
      "uri": "org/kie/kogito/examples/jsongreet.sw.json"
    }
  ],
  "approvals": [
    {
      "uri": "org/kie/kogito/examples/approval.bpmn"
    }
  ],
  "petstore_http": [
    {
    ...
    {
      "uri": "org/kie/kogito/examples/petstore_http.sw.json"
    }
  ],
  "yamlgreet": [
    {
      "uri": "org/kie/kogito/examples/yamlgreet.sw.yaml"
    }
  ],
  "demo.orderItems": [
    {
      "uri": "org/kie/kogito/examples/orderItems.bpmn2"
    }
  ]
}
----
...
* GET: `/management/process/sources/download`
** parameters:
*** name: fileName
**** in: query

.Example: to download the source file located at `org/kie/kogito/examples/ymlgreet.sw.yml`, you can use the following command:

[source,bash]
----
$ curl -X 'GET' \
  'http://localhost:8080/management/process/sources/download?fileName=org%2Fkie%2Fkogito%2Fexamples%2Fymlgreet.sw.yml' \
  -H 'accept: */*' \
  -H 'Authorization: Basic c2NvdHQ6amIwc3M='
----

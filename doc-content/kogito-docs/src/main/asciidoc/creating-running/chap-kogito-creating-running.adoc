...
On Spring Boot, you can create custom Maven project using {PRODUCT} Spring Boot starter or {PRODUCT} add-on. The {PRODUCT} Spring Boot starters include:
...
$ mvn archetype:generate \
    ...
    -Dstarters=processes
----
After executing the command, the generated project includes the dependencies that are required to run a {PRODUCT} process services. You can combine multiple {PRODUCT} Spring Boot starters using a comma-separated list. For example `starters=processes,rules`.
--

* To generate a project containing Prometheus monitoring and Infinispan persistence using {PRODUCT} add-on, enter the following command:
+
--
[source,subs="attributes+"]
----
...
NOTE: When you pass an add-on to the property, the add-on name does not require `kogito-addons-springboot` suffix. Also, you can combine the `add-ons` and `starters` property to customize the project.
--
...
== Starters for your {PRODUCT} project

The https://docs.spring.io/spring-boot/docs/current/reference/htmlsingle/#using-boot-starter[Spring Boot starters] are a set of dependency descriptors that you can include in your {PRODUCT} application. Using the Spring Boot starters, you can eliminate going through the sample code and copying-pasting various dependency descriptors.

When you create a project, the `pom.xml` file consists of all the required starters. You can also include a new starter if required. For more information about creating a project using Spring Boot starter, see xref:proc-customizing-spring-boot-project-creation_kogito-creating-running[].

[id="ref-kogito-spring-boot-starter_{context}"]
=== {PRODUCT} Spring Boot Starters

The {PRODUCT} Spring Boot starter is an all-in-one descriptor for the {PRODUCT} projects that requires business automation engine provided by {PRODUCT}. The {PRODUCT} Spring Boot starter includes decisions, rules, processes, predictions, and the Serverless Workflow implementation.

When your project consists of all the assets and you want a quick way to get started with {PRODUCT}, you can use the starters. For more granular approach, you can use the specific starters or a combination of starters.
...
{PRODUCT} decisions Spring Boot starters::
Starters for decisions such as DMN support to your {PRODUCT} Spring Boot project. You can add a {PRODUCT} decisions Spring Boot starter as follows:
...
----
{PRODUCT} predictions Spring Boot starters::
Starters for predictions such as PMML support to your {PRODUCT} Spring Boot project. You can add a {PRODUCT} predictions Spring Boot starter as follows:
...
{PRODUCT} processes Spring Boot starters::
Starters for processes such as BPMN support to your {PRODUCT} Spring Boot project. You can add a {PRODUCT} processes Spring Boot starter as follows:
...
{PRODUCT} rules Spring Boot starters::
Starters for rules such as DRL support to your {PRODUCT} Spring Boot project. You can add a {PRODUCT} rules Spring Boot starter as follows:
...
{PRODUCT} Serverless Workflow Spring Boot starters::
Starters for the Serverless Workflow support to your {PRODUCT} Spring Boot project. You can add a {PRODUCT} Serverless Workflow starter as follows:

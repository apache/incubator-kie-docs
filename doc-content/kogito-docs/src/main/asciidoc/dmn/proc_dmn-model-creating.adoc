...
ifdef::KOGITO[]
{URL_CREATING_RUNNING}#proc_kogito-vscode-extension_kogito-creating-running[_{CREATING_RUNNING}_].
endif::[]
ifdef::KOGITO-COMM[]
xref:proc_kogito-vscode-extension_kogito-creating-running[].
endif::[]

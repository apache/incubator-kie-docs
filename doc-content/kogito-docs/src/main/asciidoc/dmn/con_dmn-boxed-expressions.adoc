...
NOTE: The {PRODUCT} DMN modeler does not provide boxed list expressions, but supports a FEEL `list` data type that you can use in boxed literal expressions. For more information about the `list` data type and other FEEL data types in {PRODUCT}, see xref:ref_dmn-data-types_dmn-models[].

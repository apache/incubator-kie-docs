// If changing name, location, and structure of this document, align with Docs team; the original source of this file is the one available at https://github.com/apache/incubator-kie-drools/blob/main/kie-dmn/ref-dmn-feel-builtin-functions.adoc

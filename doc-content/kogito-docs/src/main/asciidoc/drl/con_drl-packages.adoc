...
Notice that any rule attribute (as described in the section xref:rules-attributes-ref_drl-rules[]) may also be written at package level, superseding the attribute's default value.

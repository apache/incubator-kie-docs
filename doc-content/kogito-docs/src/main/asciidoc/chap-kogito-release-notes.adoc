...
* https://issues.redhat.com/secure/ReleaseNote.jspa?projectId=12322421&version=12346577[{PRODUCT} {COMMUNITY_VERSION}]
...
include::release-notes/0.15.0/ref-kogito-rn-new-features.adoc[leveloffset=+1]
//include::release-notes/0.15.0/ref-kogito-rn-fixed-issues.adoc[leveloffset=+1]
include::release-notes/0.15.0/ref-kogito-rn-known-issues.adoc[leveloffset=+1]

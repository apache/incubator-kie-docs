...
* https://issues.redhat.com/secure/ReleaseNote.jspa?projectId=12322421&version=12345658[{PRODUCT} {COMMUNITY_VERSION}]
** https://issues.redhat.com/secure/ReleaseNote.jspa?projectId=12322421&version=12346553[{PRODUCT} tooling 0.6.1]
...
include::release-notes/0.14.0/ref-kogito-rn-new-features.adoc[leveloffset=+1]
include::release-notes/0.14.0/ref-kogito-rn-fixed-issues.adoc[leveloffset=+1]
include::release-notes/0.14.0/ref-kogito-rn-known-issues.adoc[leveloffset=+1]

...
* https://issues.redhat.com/secure/ReleaseNote.jspa?projectId=12322421&version=12346578[{PRODUCT} {COMMUNITY_VERSION}]
** https://issues.redhat.com/secure/ReleaseNote.jspa?projectId=12322421&version=12346967[{PRODUCT} tooling 0.7.0]
...
include::release-notes/0.16.0/ref-kogito-rn-new-features.adoc[leveloffset=+1]
//include::release-notes/0.16.0/ref-kogito-rn-fixed-issues.adoc[leveloffset=+1]
include::release-notes/0.16.0/ref-kogito-rn-known-issues.adoc[leveloffset=+1]

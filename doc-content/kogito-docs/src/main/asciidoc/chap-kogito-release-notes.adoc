...
include::release-notes/0.12.0/ref-kogito-rn-new-features.adoc[leveloffset=+1]
include::release-notes/0.12.0/ref-kogito-rn-fixed-issues.adoc[leveloffset=+1]
include::release-notes/0.12.0/ref-kogito-rn-known-issues.adoc[leveloffset=+1]

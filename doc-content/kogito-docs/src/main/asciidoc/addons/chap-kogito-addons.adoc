...
To use this add-on, add the following code to your pom.xml file:
...
The Explainability add-on in {PRODUCT} provides integration with Explainability and Trusty Services. You can also use https://github.com/kiegroup/kogito-examples/tree/stable/trusty-demonstration[`trusty-demonstration`] example.

For more information, see the xref:con-trusty-service_kogito-configuring[documentation].
...
[NOTE] Spring Boot does not support Knative Eventing at this time.

For more information, see xref:con-knative-eventing_kogito-developing-process-services[Knative Eventing in {PRODUCT} services].
...
The mail add-on is used to send emails in a process project. To use this add-on, add the following code to your pom.xml file:
...
For information on the Process SVG add-on, see xref:con-bpmn-process-management-addon_kogito-configuring[{PRODUCT} process management add-on].

== Process SVG

For information on the Process SVG add-on, see xref:con-bpmn-process-svg-addon_kogito-developing-process-services[{PRODUCT} process SVG add-on].
...
For information on the Tracing add-on, see xref:con-bpmn-process-management-addon_kogito-configuring[Kogito process management add-on].

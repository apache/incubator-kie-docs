...
[id="con-grafana-dashboards-custom-dashboards_{context}"]
==== Provide custom grafana dashboards in {PRODUCT}

[role="_abstract"]
User may add custom dashboards defined as `json` files. Format specification and details are provided in the https://grafana.com/docs/grafana/latest/dashboards/json-model/[Official documentation] page.

...
+
--
Updates the comment with the `commentId` from the user task instance  with the information passed in the `comment` parameter. Previously to perform the comment update operation,
kogito dataindex service needs to localize the UserTaskInstance that contains that comment to get the necessary information to do the call to the related Kogito runtime service.
The call allows you to pass the `user` and `groups` parameters even if the parameters are mandatory. If `user` and `groups` parameters are used to run the call to runtimes.
...
+
--
Deletes the comment with the `commentId` from the user task instance. Previously to perform the comment delete operation,
kogito dataindex service needs to localize the UserTaskInstance that contains that comment to get the necessary information to do the call to the related Kogito runtime service.
The call allows you to pass the `user` and `groups` parameters even if the parameters are mandatory. If `user` and `groups` parameters are used to run the call to runtimes.
...
+
--
Updates the attachment with the `attachmentId` from the user task instance  with the information passed in the `name` and `uri` parameter. Previously to perform the attachment content update operation,
kogito dataindex service needs to localize the UserTaskInstance that contains that attachment to get the necessary information to do the call to the related Kogito runtime service.
The call allows you to pass the `user` and `groups` parameters even if the parameters are mandatory. If `user` and `groups` parameters are used to run the call to runtimes.
...
+
--
Deletes the attachment with the `attachmentId` from the user task instance. Previously to perform the attachment delete operation,
kogito dataindex service needs to localize the UserTaskInstance that contains that attachment to get the necessary information to do the call to the related Kogito runtime service.
The call allows you to pass the `user` and `groups` parameters even if the parameters are mandatory. If `user` and `groups` parameters are used to run the call to runtimes.

...
[role="_abstract"]
You can add custom dashboards that are defined as `json` files. Format specification and details are provided in the https://grafana.com/docs/grafana/latest/dashboards/json-model/[Official documentation] page.

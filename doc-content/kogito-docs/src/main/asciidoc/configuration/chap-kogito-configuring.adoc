...
The Data Index GraphQL endpoint can query for `ProcessInstances` and `UserTaskInstances`. For more details about operations and attributes to query, see {URL_CONFIGURING_KOGITO}#proc-data-index-service-queries_kogito-configuring[_{PRODUCT} Data Index GraphQL queries_].

...
a|Disable the generation of domain specific proto marshaller to serialize process variables. By disabling it, Kogito will leverage Java serialization to persist process variables.

...
For this procedure, the messaging is based on https://kafka.apache.org/[Apache Kafka], so you must have Kafka installed in order to enable messaging. Your marshalling configuration depends on the messaging solution that you use.

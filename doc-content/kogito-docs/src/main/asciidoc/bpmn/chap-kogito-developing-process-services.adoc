...
NOTE: The SVG generated by the VSCode export to SVG of a process contained in a {processFileName}.bpmn (or .bpmn2) is named to {processFileName}-svg.svg.
The process code generation searches this export and, if this file exists, copies and renames it to `META-INF/processSVG/{processId}.svg

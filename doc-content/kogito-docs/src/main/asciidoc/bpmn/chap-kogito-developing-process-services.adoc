...
[role="_abstract"]
For {PRODUCT} management console, you can use https://github.com/keycloak/keycloak-documentation/blob/master/securing_apps/topics/oidc/javascript-adapter.adoc[Keycloak-js-adapter] to enable security and interact with the data-index and the runtime using bearer token authorization. These tokens are issued by OpenID Connect and OAuth 2.0 compliant authorization servers such as https://www.keycloak.org/about.html[Keycloak].
...
+
* `kogito.consoles.keycloak.config.url`: The base URL of the OpenID Connect (OIDC) server, such as `https://localhost:8280/auth`. All other OIDC server page and service URLs are derived from this URL.
...
* `kogito.consoles.keycloak.config.disable-health-check`: It is upto the user to decide whether the health check is required. By default, the health check is always enabled.
...
[role="_abstract"]
For {PRODUCT} task console, you can use https://github.com/keycloak/keycloak-documentation/blob/master/securing_apps/topics/oidc/javascript-adapter.adoc[Keycloak-js-adapter] to enable security and interact with the data-index and the runtime using bearer token authorization. These tokens are issued by OpenID Connect and OAuth 2.0 compliant authorization servers such as https://www.keycloak.org/about.html[Keycloak].

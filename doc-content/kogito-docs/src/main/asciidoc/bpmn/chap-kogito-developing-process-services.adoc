...
NOTE: You can override these properties anytime by adding them to the `src/main/resources/application.properties` file in your project.
...
+
If you plan to run the application locally, please take a look at the example https://github.com/kiegroup/kogito-examples/tree/stable/process-knative-quickstart-quarkus[Process Knative Quickstart Quarkus]. You can configure the environment in your local machine using https://knative.dev/docs/eventing/samples/container-source/#create-a-knative-service[Knative Event Display].
+
--

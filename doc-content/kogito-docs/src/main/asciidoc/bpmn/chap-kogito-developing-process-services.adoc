...
NOTE: For testing purposes, Management Console also provides a Test User System that can be enabled by using the `kogito.test.user-system.enabled=true`.
...
NOTE: For testing purposes, Task Console also provides a Test User System that can be enabled by using the `kogito.test.user-system.enabled=true`.

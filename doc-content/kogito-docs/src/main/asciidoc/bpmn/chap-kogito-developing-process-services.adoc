...
+
--
This panel allows to explore the process diagram and execution path of the related process instance when the management console is able to find the .svg resources via
{PRODUCT} process SVG add-on configuration included at {PRODUCT} Management console.

.Process Diagram panel
image::kogito/bpmn/kogito-management-console-process-diagram-panel.png[Image of process instance diagram panel]

This panel includes different controls to be able to visualize the process diagram allowing: Selection, Pan, Zoom in, Zoom out and Fit to viewer.
--

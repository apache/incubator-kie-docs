...
* *Process Instances*: Use this page to find process and subprocess instances by status or business key.
* *Domain Explorer*: Use this page to explore your process instances in the available {PRODUCT} services, through the domain specific data.
...
Finally, the view that encapsulates the process instance details and the allowed interactions with a process instance

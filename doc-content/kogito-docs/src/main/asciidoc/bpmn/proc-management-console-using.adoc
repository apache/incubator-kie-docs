...
+
Milestones panel of the *Process Details* page displays list of milestones available for a process instance, along with its status.
+
.Process instance milestones
image::kogito/bpmn/kogito-management-console-milestones-panel.png[Image of process instance milestones in Management Console]

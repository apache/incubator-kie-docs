...
+
A list of nodes that can be triggered is available in the dropdown. Select a node to trigger and click the 'Trigger' button to trigger the respective node.
+
.Node trigger panel

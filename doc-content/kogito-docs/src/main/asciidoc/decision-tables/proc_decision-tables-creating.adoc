...
IMPORTANT: In order to enable support to decision tables you will need to add the following dependency
...
ifdef::KOGITO[]
For instance, you can add this property to your `application.conf`
...
If you are starting {DECISION_ENGINE} from a command line you can add the system property using:

.Example using Quarkus
[source]
----

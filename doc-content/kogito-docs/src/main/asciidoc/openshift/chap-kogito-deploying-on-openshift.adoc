...
NOTE: The {PRODUCT} images are handling the binary build directly from the `target` folder, and the content of the folder `target/quarkus-app` will be copied directly.

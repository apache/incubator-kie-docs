...
`{PRODUCT_INIT} deploy-service travels \https://github.com/kiegroup/kogito-examples/kogito-travel-agency/extended --context-dir travels`
...
`{PRODUCT_INIT} deploy-service travels \https://github.com/kiegroup/kogito-examples/kogito-travel-agency/extended --context-dir travels --enable-persistence --enable-events`
...
`{PRODUCT_INIT} deploy-service travels \https://github.com/kiegroup/kogito-examples/kogito-travel-agency/extended --context-dir travels --native`
endif::[]

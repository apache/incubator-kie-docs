[id='proc_kogito-travel-agency-deploy-binary_{context}']
...
.Procedure
. In a command terminal, navigate to the `08-kogito-travel-agency` directory in your local travel agency tutorial Git repository and build the project using Maven:
+
--
.Building the local travel agency project
[source]
----
$ cd 08-kogito-travel-agency
$ mvn clean package
----
...
. From the same `08-kogito-travel-agency` directory location where you built the project, enter the following command to deploy the travel agency application to OpenShift using a binary build:
+
--
...
--
. In a command terminal, navigate to the `08-kogito-visas` directory in your local travel agency tutorial Git repository and build the project using Maven:
+
--
